...
(function (V, L) {
  ...
  var L = function () {
    var a = "undefined" === typeof V ? window : V, B = a.document, C = a.navigator && a.navigator.userAgent || "",
      G = B && B.createElementNS && !!B.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
      p = /(edge|msie|trident)/i.test(C) && !a.opera, m = -1 !== C.indexOf("Firefox"), g = -1 !== C.indexOf("Chrome"),
  ...
  (function (a) {
    a.timers = [];
    var B = a.charts, C = a.doc, G = a.win;
    ...
    a.Fx.prototype = {
      dSetter: function () {
        var a = this.paths[0], m = this.paths[1], g = [], v = this.now, z = a.length, u;
        if (1 === v) g = this.toD; else if (z === m.length && 1 > v) for (; z--;) u = parseFloat(a[z]), g[z] = isNaN(u) ? m[z] : v * parseFloat(m[z] - u) + u; else g = m;
        this.elem.attr("d",
          g, null, !0)
      }, update: function () {
        var a = this.elem, m = this.prop, g = this.now, v = this.options.step;
        if (this[m + "Setter"]) this[m + "Setter"](); else a.attr ? a.element && a.attr(m, g, null, !0) : a.style[m] = g + this.unit;
        v && v.call(a, g, this)
      }, run: function (p, m, g) {
        var v = this, z = v.options, u = function (a) {
        ...
        var m = +new Date, g, v = this.options, z = this.elem, u = v.complete, y = v.duration, l = v.curAnim;
        ...
        m = m || "";
        var y, l = p.startX, b = p.endX, e = -1 < m.indexOf("C"), t = e ? 7 : 3, n, f, c;
        m = m.split(" ");
        g = g.slice();
        var h = p.isArea, w = h ? 2 : 1, D;
        e && (v(m), v(g));
        if (l && b) {
          for (c = 0; c < l.length; c++) if (l[c] === b[0]) {
            y = c;
            break
    ...
    a.merge = function () {
      var p, m = arguments, g, v = {}, z = function (g, y) {
        "object" !== typeof g && (g = {});
    ...
    a.pick = function () {
      var a = arguments, m, g, v = a.length;
      for (m = 0; m < v; m++) if (g = a[m], void 0 !== g && null !== g) return g
    };
    a.css = function (p, m) {
    ...
    a.createElement = function (p, m, g, v, z) {
      ...
      var u =
        a.css;
      m && a.extend(p, m);
      z && u(p, {padding: 0, border: "none", margin: 0});
      g && u(p, g);
      v && v.appendChild(p);
      return p
    };
    ...
    a.wrap = function (a, m, g) {
      var v = a[m];
      a[m] = function () {
        var a = Array.prototype.slice.call(arguments), u = arguments, y = this;
        y.proceed = function () {
    ...
    a.formatSingle = function (p, m, g) {
      var v = /\.([0-9])/, z = a.defaultOptions.lang;
    ...
    a.numberFormat = function (p, m, g, v) {
      p = +p || 0;
      m = +m;
      var z = a.defaultOptions.lang, u = (p.toString().split(".")[1] || "").split("e")[0].length, y, l,
        b = p.toString().split("e");
      -1 === m ? m = Math.min(u, 20) : a.isNumber(m) ? m && b[1] && 0 > b[1] && (y = m + +b[1], 0 <= y ? (b[0] = (+b[0]).toExponential(y).split("e")[0], m = y) : (b[0] = b[0].split(".")[0] || 0, p = 20 > m ? (b[0] * Math.pow(10, b[1])).toFixed(m) : 0, b[1] = 0)) : m = 2;
    ...
    a.find = Array.prototype.find ? function (a, m) {
      ...
      var g, v = a.length;
      for (g = 0; g < v; g++) if (m(a[g], g)) return a[g]
    };
    ...
    a.removeEvent = function (p, m, g) {
      ...
      function z(l) {
        ...
        p.nodeName && (m ? (b = {}, b[m] = !0) : b = l, a.objectEach(b, function (a, b) {
          if (l[b]) for (e = l[b].length; e--;) v(b, l[b][e])
        }))
      }
      ...
      a.each(["protoEvents", "hcEvents"], function (l) {
        var b = p[l];
        b && (m ? (u = b[m] || [], g ? (y = a.inArray(g, u), -1 < y && (u.splice(y, 1), b[m] = u), v(m, g)) : (z(b), b[m] =
          [])) : (z(b), p[l] = {}))
      })
    };
    a.fireEvent = function (p, m, g, v) {
      ...
      C.createEvent && (p.dispatchEvent || p.fireEvent) ? (z = C.createEvent("Events"), z.initEvent(m, !0, !0), a.extend(z, g), p.dispatchEvent ? p.dispatchEvent(z) : p.fireEvent(m, z)) : a.each(["protoEvents", "hcEvents"], function (e) {
        if (p[e]) for (u = p[e][m] || [], y = u.length, g.target || a.extend(g, {
    ...
    a.animate = function (p, m, g) {
      var v, z = "", u, y, l;
      a.isObject(g) || (l = arguments, g = {duration: l[2], easing: l[3], complete: l[4]});
    ...
    a.seriesType = function (p, m, g, v, z) {
      var u = a.getOptions(), y = a.seriesTypes;
      u.plotOptions[p] = a.merge(u.plotOptions[m], g);
      y[p] = a.extendClass(y[m] || function () {
      }, v);
  ...
  (function (a) {
    var B = a.each, C = a.isNumber, G = a.map, p = a.merge, m = a.pInt;
    a.Color = function (g) {
    ...
    a.Color.prototype = {
      parsers: [{
        ...
        }); else if (g && g.charAt && "#" === g.charAt() && (m = g.length, g = parseInt(g.substr(1), 16), 7 === m ? z = [(g & 16711680) >> 16, (g & 65280) >> 8, g & 255, 1] : 4 === m && (z = [(g & 3840) >> 4 | (g & 3840) >> 8, (g & 240) >> 4 | g & 240, (g & 15) << 4 | g & 15, 1])), !z) for (u = this.parsers.length; u-- &&
        !z;) y = this.parsers[u], (m = y.regex.exec(g)) && (z = y.parse(m));
        this.rgba = z || []
      }, get: function (a) {
        var g = this.input, m = this.rgba, u;
        ...
        if (this.stops) B(this.stops, function (g) {
          g.brighten(a)
        }); else if (C(a) && 0 !== a) for (g = 0; 3 > g; g++) z[g] += m(255 * a), 0 >
  ...
  (function (a) {
    var B, C, G = a.addEvent, p = a.animate, m = a.attr, g = a.charts,
      v = a.color, z = a.css, u = a.createElement, y = a.defined, l = a.deg2rad, b = a.destroyObjectProperties,
      e = a.doc, t = a.each, n = a.extend, f = a.erase, c = a.grep, h = a.hasTouch, w = a.inArray, D = a.isArray,
      r = a.isFirefox, J = a.isMS, q = a.isObject, F = a.isString, x = a.isWebKit, K = a.merge, d = a.noop,
      H = a.objectEach, E = a.pick, k = a.pInt, A = a.removeEvent, P = a.stop, R = a.svg, I = a.SVG_NS,
    ...
    n(B.prototype, {
      ...
      complexColor: function (k, d, A) {
        var M = this.renderer, b, f, c, h, I, x, n, r, e, w, E, q = [], l;
        a.fireEvent(this.renderer, "complexColor", {args: arguments}, function () {
          ...
          f && (c = k[f], I = M.gradients, n = k.stops, w = A.radialReference, D(c) && (k[f] = c = {
          ...
          }), "radialGradient" === f && w && !y(c.gradientUnits) && (h = c, c = K(c, M.getRadialAttr(w, h), {gradientUnits: "userSpaceOnUse"})), H(c, function (a, k) {
            "id" !== k && q.push(k, a)
          }), H(n, function (a) {
            q.push(a)
            ...
            k = M.createElement("stop").attr({offset: k[0], "stop-color": r, "stop-opacity": e}).add(x);
            x.stops.push(k)
      ...
      applyTextOutline: function (k) {
        var d = this.element, M, A, b, c, h;
        -1 !== k.indexOf("contrast") && (k = k.replace(/contrast/g, this.renderer.getContrast(d.style.fill)));
        k = k.split(" ");
        A = k[k.length - 1];
      ...
      attr: function (a,
                      k, d, A) {
        var M, b = this.element, f, c = this, h, I;
      ...
      addClass: function (a, k) {
        ...
        -1 === d.indexOf(a) && (k || (a = (d + (d ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
        return this
      },
      hasClass: function (a) {
        return -1 !==
      ...
      css: function (a) {
        var d = this.styles, A = {}, b = this.element, f, c = "", M, h = !d,
      ...
      updateTransform: function () {
        var a = this.translateX || 0, k = this.translateY || 0, d = this.scaleX, A = this.scaleY, b = this.inverted,
          f = this.rotation, c = this.matrix, h = this.element;
      ...
      getBBox: function (a, k) {
        var d, A = this.renderer, b, c = this.element, f = this.styles, h, I = this.textStr, M, x = A.cache,
          r = A.cacheKeys, e;
        k = E(k, this.rotation);
        b = k * l;
        h = f && f.fontSize;
      ...
      add: function (a) {
        var k = this.renderer, d = this.element,
          A;
      ...
      destroy: function () {
        var a = this, k = a.element || {}, d = a.renderer.isSVG && "SPAN" === k.nodeName && a.parentGroup,
          A = k.ownerSVGElement, b = a.clipPath;
        k.onclick = k.onmouseout = k.onmouseover = k.onmousemove = k.point =
          null;
        P(a);
        b && A && (t(A.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
          var k = a.getAttribute("clip-path"), d = b.element.id;
      ...
      shadow: function (a, k, d) {
        var A = [], b, c, f = this.element, h, I, x, n;
      ...
      zIndexSetter: function (a, d) {
        var A = this.renderer, b = this.parentGroup, c = (b || A).element || A.box, f, h = this.element, I, x,
          A = c === A.box;
        f = this.added;
        var n;
        ...
        if (f) {
          ...
          d = c.childNodes;
          for (n = d.length - 1; 0 <= n && !I; n--) if (b = d[n], f = b.zIndex, x = !y(f), b !== h) if (0 > a && x && !A && !n) c.insertBefore(h, d[n]), I = !0; else if (k(f) <= a || x && (!y(a) || 0 <= a)) c.insertBefore(h, d[n + 1] || null), I = !0;
    ...
    n(C.prototype, {
      ...
      init: function (a, k, d, A, b, c) {
        var f;
        A = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}).css(this.getStyle(A));
        f = A.element;
        a.appendChild(f);
        m(a, "dir", "ltr");
        ...
        r && a.getBoundingClientRect && (k = function () {
          ...
          z(a, {
            ...
            h.left + "px", top: Math.ceil(h.top) - h.top + "px"
          })
      ...
      applyEllipsis: function (a, k, d, A) {
        var b = a.rotation, c = d, f, h = 0, I = d.length, x = function (a) {
      ...
      buildText: function (a) {
        var d = a.element, A = this, b = A.forExport, f = E(a.textStr, "").toString(), h = -1 !== f.indexOf("\x3c"),
          x = d.childNodes, n, r = m(d, "x"), q = a.styles, l = a.textWidth, D = q && q.lineHeight,
          F = q && q.textOutline, P = q && "ellipsis" === q.textOverflow, K = q && "nowrap" ===
          q.whiteSpace, M = q && q.fontSize, J, g, Q = x.length, q = l && !a.added && this.box, u = function (a) {
            var b;
        ...
        if (J !== a.textCache) {
          ...
          h || F || P || l || -1 !== f.indexOf(" ") ? (q && q.appendChild(d), f = h ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f], f = c(f, function (a) {
            ...
            t(c, function (k) {
              if ("" !== k || 1 === c.length) {
                var x = {}, q = e.createElementNS(A.SVG_NS, "tspan"), w, E;
                (w = N(k, "class")) && m(q, "class", w);
                if (w = N(k, "style")) w = w.replace(/(;| |^)color([ :])/, "$1fill$2"), m(q, "style", w);
                (E = N(k, "href")) && !b && (m(q, "onclick", 'location.href\x3d"' + E + '"'), m(q, "class", "highcharts-anchor"), z(q, {cursor: "pointer"}));
                ...
                if (" " !== k) {
                  ...
                  m(q, x);
                  d.appendChild(q);
                  !h && g && (!R && b && z(q, {display: "block"}), m(q, "dy", u(q)));
                  if (l) {
                    x = k.replace(/([^\^])-/g, "$1- ").split(" ");
                    E = 1 < c.length || f || 1 < x.length && !K;
                    var H = [], D, t = u(q), F = a.rotation;
      ...
      button: function (a, k, d, A, b, f, c, h, x) {
        var I = this.label(a, k, d, x, null, null, null, null, "button"), q = 0;
        I.attr(K({padding: 8, r: 2}, b));
        var r,
          e, w, E;
        b = K({
          fill: "#f7f7f7",
        ...
        e = f.style;
        delete f.style;
        c = K(b, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, c);
        w = c.style;
        delete c.style;
        h = K(b, {style: {color: "#cccccc"}}, h);
        E = h.style;
        delete h.style;
        ...
        I.attr(b).css(n({cursor: "default"}, r));
      ...
      arc: function (a, k, d, A, b, f) {
        q(a) ? (A = a, k = A.y, d = A.r, a = A.x) : A = {innerR: A, start: b, end: f};
      ...
      rect: function (a, k, d, A, b, f) {
        ...
        a = q(a) ? a : void 0 === a ? {} : {x: a, y: k, width: Math.max(d, 0), height: Math.max(A, 0)};
      ...
      setSize: function (a, k, d) {
        var A = this.alignedObjects, b = A.length;
        this.width = a;
        this.height = k;
      ...
      image: function (a, k, d, A, b, f) {
        ...
        1 < arguments.length && n(c, {x: k, y: d, width: A, height: b});
      ...
      symbol: function (a, k, d, A, b, c) {
        var f = this, h, I = /^url\((.*?)\)$/, x = I.test(a), q = !x && (this.symbols[a] ?
          a : "circle"), r = q && this.symbols[q],
          w = y(k) && r && r.call(this.symbols, Math.round(k), Math.round(d), A, b, c), l, H;
        r ? (h = this.path(w), h.attr("fill", "none"), n(h, {
          ...
          h[a + "Setter"] = function (a, k) {
            var d = {}, A = this["img" + k], b = "width" === k ? "translateX" : "translateY";
            this[k] = a;
            y(A) && (this.element && this.element.setAttribute(k, A), this.alignByTranslate || (d[b] = ((this[k] || 0) - A) / 2, this.attr(d)))
          }
        }), y(k) && h.attr({x: k, y: d}), h.isImg = !0, y(h.imgwidth) && y(h.imgheight) ? H() : (h.attr({
          width: 0,
          height: 0
        }), u("img", {
          onload: function () {
            var a = g[f.chartIndex];
            0 === this.width && (z(this, {position: "absolute", top: "-999em"}), e.body.appendChild(this));
      ...
      symbols: {
        circle: function (a, k, d, A) {
          return this.arc(a + d / 2, k + A / 2, d / 2, A / 2, {start: 0, end: 2 * Math.PI, open: !1})
          ...
          return ["M", a + d / 2, k, "L", a + d, k + A / 2, a + d / 2, k + A, a, k + A / 2, "Z"]
                          ...
                          k, d, A, b) {
          var c = b.start, f = b.r || d, h = b.r || A || d, I = b.end - .001;
          d = b.innerR;
          A = E(b.open, .001 > Math.abs(b.end - b.start - 2 * Math.PI));
          var x = Math.cos(c), n = Math.sin(c), q = Math.cos(I), I = Math.sin(I);
          ...
          var c = Math.min(b && b.r || 0, d, A), f = c + 6, h = b && b.anchorX;
          b = b && b.anchorY;
          var I;
      ...
      clipRect: function (k, d, A,
                          b) {
        var c = a.uniqueKey(), f = this.createElement("clipPath").attr({id: c}).add(this.defs);
      ...
      text: function (a, k, d, A) {
        ...
        A || (a.xSetter = function (a, k, d) {
          var A = d.getElementsByTagName("tspan"), b, c = d.getAttribute(k), f;
      ...
      rotCorr: function (a, k, d) {
        ...
        return {x: -a / 3 * Math.sin(k * l), y: A}
      },
      label: function (k, d, b, c, f, h, I, x, q) {
        var r = this, e = r.g("button" !== q && "label"), w = e.text = r.text("", 0, 0, I).attr({zIndex: 1}),
          E, l, H = 0, D = 3, F = 0, R, P, J, g, Q, m = {}, u, N, v = /^url\((.*?)\)$/.test(c), z = v, M, p, S, O;
        ...
        S = function () {
          var a = F + D, k;
          k = x ? 0 : N;
          y(R) && l && ("center" === Q || "right" === Q) && (a += {center: .5, right: 1}[Q] * (R - l.width));
        ...
        e.onAdd = function () {
          w.add(e);
          e.attr({text: k || 0 === k ? k : "", x: d, y: b});
          E && y(f) && e.attr({anchorX: f, anchorY: h})
        };
        ...
        return n(e, {
          css: function (a) {
            ...
            return {
              width: l.width + 2 * D, height: l.height +
              2 * D, x: l.x - D, y: l.y - D
            }
          }, shadow: function (a) {
            a && (p(), E && E.shadow(a));
  ...
  (function (a) {
    var B = a.attr, C = a.createElement, G = a.css, p = a.defined, m = a.each, g = a.extend, v = a.isFirefox,
      z = a.isMS, u = a.isWebKit, y = a.pick, l = a.pInt, b = a.SVGRenderer, e = a.win, t = a.wrap;
    g(a.SVGElement.prototype, {
      htmlCss: function (a) {
        ...
        if (this.added) {
          var a = this.renderer, b = this.element, c = this.translateX || 0, h = this.translateY || 0, e = this.x || 0,
            D = this.y || 0, r = this.textAlign ||
            "left", t = {left: 0, center: .5, right: 1}[r], q = this.styles, F = q && q.whiteSpace;
          G(b, {marginLeft: c, marginTop: h});
          ...
          if ("SPAN" === b.tagName) {
            var q = this.rotation, x = this.textWidth && l(this.textWidth),
              K = [q, r, b.innerHTML, this.textWidth, this.textAlign].join(), d;
            ...
            G(b, {left: e + (this.xCorr || 0) + "px", top: D + (this.yCorr || 0) + "px"});
            this.cTT = K;
            this.oldRotation = q
          }
    ...
    g(b.prototype, {
      getTransformKey: function () {
        ...
        var f = this.createElement("span"), e = f.element, n = f.renderer, r = n.isSVG, l = function (a, b) {
          m(["opacity", "visibility"], function (c) {
            t(a,
              c + "Setter", function (a, d, c, f) {
                a.call(this, d, c, f);
                b[c] = d
              })
          });
        ...
        f.attr({text: a, x: Math.round(b), y: Math.round(c)}).css({
  ...
  (function (a) {
    var B = a.defined, C = a.each, G = a.extend, p = a.merge, m = a.pick, g = a.timeUnits, v = a.win;
    a.Time = function (a) {
      this.update(a, !1)
    };
    a.Time.prototype = {
      defaultOptions: {}, update: function (g) {
        var u = m(g && g.useUTC, !0), y = this;
        ...
        (this.variableTimezone = !(u && !g.getTimezoneOffset && !g.timezone)) || this.timezoneOffset ? (this.get = function (a, b) {
          var e = b.getTime(), l = e - y.getTimezoneOffset(b);
          b.setTime(l);
          a = b["getUTC" + a]();
          b.setTime(e);
          return a
          ...
          this.set = function (l, b, e) {
            var t;
            if (-1 !== a.inArray(l, ["Milliseconds", "Seconds", "Minutes"])) b["set" + l](e); else t = y.getTimezoneOffset(b), t = b.getTime() - t, b.setTime(t), b["setUTC" + l](e), l = y.getTimezoneOffset(b), t = b.getTime() + l, b.setTime(t)
        ...
        var g = this, m = this.options, y = v.moment;
        ...
        var l = this, b = new this.Date(m), e = this.get("Hours", b), t = this.get("Day", b), n = this.get("Date", b),
          f = this.get("Month", b), c = this.get("FullYear", b), h = a.defaultOptions.lang, w = h.weekdays,
          D = h.shortWeekdays, r = a.pad, b = a.extend({
        ...
        var b = this, e = [], t = {}, n, f = new b.Date(u), c = a.unitRange, h = a.count || 1, w;
        if (B(u)) {
          b.set("Milliseconds",
          ...
          n = b.get("FullYear", f);
          l = b.get("Month", f);
          var D = b.get("Date", f), r = b.get("Hours", f);
          u = f.getTime();
        ...
        e.info = G(a, {higherRanks: t, totalRange: c * h});
        return e
      }
    }
  })(L);
  (function (a) {
    var B = a.color, C = a.merge;
    a.defaultOptions = {
  ...
  (function (a) {
    var B = a.correctFloat, C = a.defined, G = a.destroyObjectProperties, p = a.fireEvent, m = a.isNumber, g = a.merge,
      v = a.pick, z = a.deg2rad;
    ...
    a.Tick.prototype = {
      addLabel: function () {
        var a = this.axis, m = a.options, l = a.chart, b = a.categories, e = a.names, t = this.pos, n = m.labels,
          f = a.tickPositions, c = t === f[0], h = t === f[f.length - 1], e = b ? v(b[t], e[t], t) : t, b = this.label,
          f = f.info, w;
        ...
        var g = this.axis, l = g.options.labels, b = a.x, e = g.chart.chartWidth, t = g.chart.spacing,
          n = v(g.labelLeft, Math.min(g.pos, t[3])),
          t = v(g.labelRight, Math.max(g.isRadial ? 0 : g.pos + g.len, e - t[1])), f = this.label, c = this.rotation,
          h = {left: 0, center: .5, right: 1}[g.labelAlign || f.attr("align")], w = f.getBBox().width,
          D = g.getSlotWidth(), r = D, J = 1, q, F = {};
        if (c || !1 === l.overflow) 0 > c && b - h * w < n ? q = Math.round(b /
          Math.cos(c * z) - n) : 0 < c && b + h * w > t && (q = Math.round((e - b) / Math.cos(c * z))); else if (e = b + (1 - h) * w, b - h * w < n ? r = a.x + r * (1 - h) - n : e > t && (r = t - a.x + r * h, J = -1), r = Math.min(D, r), r < D && "center" === g.labelAlign && (a.x += J * (D - r - h * (D - Math.min(w, r)))), w > r || g.autoRotation && (f.styles || {}).width) q = r;
        q && (F.width = q, (l.style || {}).textOverflow || (F.textOverflow = "ellipsis"), f.css(F))
      }, getPosition: function (g, m, l, b) {
        var e = this.axis, t = e.chart, n = b && t.oldChartHeight || t.chartHeight;
        g = {
        ...
        p(this, "afterGetPosition", {pos: g});
        return g
      }, getLabelPosition: function (a, g, l, b, e, t, n, f) {
        var c = this.axis, h = c.transA, w = c.reversed, D = c.staggerLines, r = c.tickRotCorr || {x: 0, y: 0}, J = e.y,
          q = b || c.reserveSpaceDefault ? 0 : -c.labelOffset * ("center" === c.labelAlign ? .5 : 1), F = {};
        ...
        F.x = a;
        F.y = Math.round(g);
        p(this, "afterGetLabelPosition", {pos: F});
        return F
      }, getMarkPath: function (a, g, l, b, e, t) {
        return t.crispLine(["M", a, g, "L", a + (e ? 0 : -l), g + (e ? l : 0)], b)
      }, renderGridLine: function (a, g, l) {
        var b = this.axis, e = b.options, t = this.gridLine, n = {}, f = this.pos, c = this.type, h = b.tickmarkOffset,
          w = b.chart.renderer, D = c ? c + "Grid" :
          "grid", r = e[D + "LineWidth"], J = e[D + "LineColor"], e = e[D + "LineDashStyle"];
        ...
        var b = this.axis, e = b.options, t = b.chart.renderer, n = this.type, f = n ? n + "Tick" : "tick",
          c = b.tickSize(f), h = this.mark, w = !h,
          D = a.x;
        a = a.y;
        var r = v(e[f + "Width"], !n && b.isXAxis ? 1 : 0), e = e[f + "Color"];
        c && (b.opposite && (c[0] = -c[0]), w && (this.mark = h = t.path().addClass("highcharts-" + (n ? n + "-" : "") + "tick").add(b.axisGroup), h.attr({
          stroke: e,
          "stroke-width": r
        })), h[w ? "attr" : "animate"]({d: this.getMarkPath(D, a, c[0], h.strokeWidth() * l, b.horiz, t), opacity: g}))
      }, renderLabel: function (a, g, l, b) {
        var e = this.axis, t = e.horiz, n = e.options, f = this.label, c = n.labels, h = c.step, e = e.tickmarkOffset,
          w = !0, D = a.x;
        a = a.y;
        ...
        var b = this.axis, e = b.horiz, t = this.getPosition(e, this.pos, b.tickmarkOffset, m), n = t.x, f = t.y,
  ...
  var da = function (a) {
    var B = a.addEvent, C = a.animObject, G = a.arrayMax, p = a.arrayMin, m = a.color, g = a.correctFloat,
      v = a.defaultOptions, z = a.defined, u = a.deg2rad, y = a.destroyObjectProperties, l = a.each, b = a.extend,
      e = a.fireEvent, t = a.format, n = a.getMagnitude, f = a.grep, c = a.inArray, h = a.isArray, w = a.isNumber,
      D = a.isString, r = a.merge, J = a.normalizeTickInterval, q = a.objectEach, F = a.pick,
      x = a.removeEvent, K = a.splat, d = a.syncTimeout, H = a.Tick, E = function () {
        this.init.apply(this, arguments)
      };
    a.extend(E.prototype, {
      ...
      init: function (a, d) {
        ...
        d = b.options.events;
        -1 === c(b, a.axes) && (k ? a.axes.splice(a.xAxis.length,
      ...
      defaultLabelFormatter: function () {
        var k = this.axis, d = this.value, b = k.chart.time, c = k.categories, f = this.dateTimeLabelFormat, h = v.lang,
          x = h.numericSymbols, h = h.numericSymbolMagnitude || 1E3, e = x && x.length, r, n = k.options.labels.format,
          k = k.isLog ? Math.abs(d) : k.tickInterval;
        if (n) r = t(n, this, b); else if (c) r = d; else if (f) r = b.dateFormat(f, d); else if (e && 1E3 <= k) for (; e-- && void 0 === r;) b = Math.pow(h, e + 1), k >= b && 0 === 10 * d % b && null !== x[e] && 0 !== d && (r = a.numberFormat(d / b,
          -1) + x[e]);
        ...
        e(this, "getSeriesExtremes", null, function () {
          ...
          l(a.series, function (k) {
            if (k.visible || !d.options.chart.ignoreHiddenSeries) {
              var b = k.options, A = b.threshold, c;
      ...
      translate: function (a, d, b, c, f, h) {
        var k = this.linkedParent || this, A = 1, x = 0, I = c ?
      ...
      getPlotLinePath: function (a,
                                 d, b, c, f) {
        var k = this.chart, A = this.left, h = this.top, x, I, e = b && k.oldChartHeight || k.chartHeight,
          r = b && k.oldChartWidth || k.chartWidth, n;
        x = this.transB;
      ...
      getMinorTickPositions: function () {
        var a = this, d = a.options, b = a.tickPositions, c = a.minorTickInterval, f = [], h = a.pointRangePadding || 0,
          x = a.min -
            h, h = a.max + h, e = h - x;
        if (e && e / c < a.len / 3) if (a.isLog) l(this.paddedTicks, function (k, d, b) {
          d && f.push.apply(f, a.getLogTickPositions(c, b[d - 1], b[d], !0))
        }); else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(c), x, h, d.startOfWeek)); else for (d = x + (b[0] - x) % c; d <= h && d !== f[0]; d += c) f.push(d);
        0 !== f.length && a.trimTicks(f);
        return f
      },
      adjustForMinRange: function () {
        var a = this.options, d = this.min, b = this.max, c, f, h, x, e, r, n, q;
        this.isXAxis && void 0 === this.minRange && !this.isLog &&
        (z(a.min) || z(a.max) ? this.minRange = null : (l(this.series, function (a) {
          r = a.xData;
          for (x = n = a.xIncrement ? 1 : r.length - 1; 0 < x; x--) if (e = r[x] - r[x - 1], void 0 === h || e < h) h = e
      ...
      getClosest: function () {
        ...
        this.categories ? a = 1 : l(this.series, function (k) {
          var d = k.closestPointRange, b = k.visible || !k.chart.options.chart.ignoreHiddenSeries;
          !k.noSharedTooltip && z(d) && b && (a = z(a) ? Math.min(a, d) : d)
        });
        return a
      },
      nameToX: function (a) {
        var k = h(this.categories), d = k ? this.categories : this.names, b = a.options.x, f;
        a.series.requireSorting = !1;
        z(b) || (b = !1 === this.options.uniqueNames ? a.series.autoIncrement() : k ? c(a.name, d) : F(d.keys[a.name], -1));
        -1 === b ? k || (f = d.length) :
          f = b;
      ...
      setAxisTranslation: function (a) {
        var k = this, d = k.max - k.min, b =
          k.axisPointRange || 0, c, f = 0, h = 0, x = k.linkedParent, r = !!k.categories, n = k.transA, q = k.isXAxis;
      ...
      setTickInterval: function (k) {
        var d = this, b = d.chart, c = d.options, f = d.isLog, h = d.isDatetimeAxis, x = d.isXAxis, r = d.isLinked,
          q = c.maxPadding, E = c.minPadding, D = c.tickInterval, H = c.tickPixelInterval, t = d.categories,
          K = w(d.threshold) ? d.threshold : null, m = d.softThreshold, y, v, u, p;
      ...
      setTickPositions: function () {
        var a =
          this.options, d, b = a.tickPositions;
        d = this.getMinorTickInterval();
        var c = a.tickPositioner, f = a.startOnTick, h = a.endOnTick;
      ...
      trimTicks: function (a, d, b) {
        var k = a[0], c = a[a.length - 1], f = this.minPointOffset || 0;
        if (!this.isLinked) {
          if (d && -Infinity !== k) this.min = k; else for (; this.min - f > a[0];) a.shift();
          if (b) this.max = c; else for (; this.max + f < a[a.length - 1];) a.pop();
      ...
      alignToOthers: function () {
        ...
        this.isLog || l(this.chart[this.coll], function (k) {
          var b = k.options, b = [k.horiz ? b.left : b.top, b.width, b.height, b.pane].join();
      ...
      adjustTickAmount: function () {
        var a = this.tickInterval, d =
            this.tickPositions, b = this.tickAmount, c = this.finalTickAmt, f = d && d.length,
      ...
      zoom: function (a, d) {
        var k = this.dataMin, b = this.dataMax, c = this.options, f = Math.min(k, F(c.min, k)),
          c = Math.max(b, F(c.max, b));
        if (a !== this.min || d !== this.max) this.allowZoomOutside || (z(k) &&
        (a < f && (a = f), a > c && (a = c)), z(b) && (d < f && (d = f), d > c && (d = c))), this.displayBtn = void 0 !== a || void 0 !== d, this.setExtremes(a, d, !1, void 0, {trigger: "zoom"});
        return !0
      },
      setAxisSize: function () {
        var d = this.chart, b = this.options, c = b.offsets || [0, 0, 0, 0], f = this.horiz,
      ...
      getThreshold: function (a) {
        var d = this.isLog, k = d ? this.lin2log(this.min) : this.min, d = d ? this.lin2log(this.max) :
          this.max;
      ...
      tickSize: function (a) {
        var d = this.options, k = d[a + "Length"], b = F(d[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
      ...
      unsquish: function () {
        var a = this.options.labels, d = this.horiz, b = this.tickInterval, c = b,
          f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / b), h, x = a.rotation,
          e = this.labelMetrics(), r, q = Number.MAX_VALUE, n, w = function (a) {
            a /= f || 1;
            a = 1 < a ? Math.ceil(a) : 1;
            return g(a * b)
          };
      ...
      getSlotWidth: function () {
        var a = this.chart, d = this.horiz, b = this.options.labels,
          c = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), f = a.margin[3];
      ...
      renderUnsquish: function () {
        var a = this.chart, d = a.renderer, b = this.tickPositions, c = this.ticks,
          f = this.options.labels, h = this.horiz, x = this.getSlotWidth(),
          e = Math.max(1, Math.round(x - 2 * (f.padding || 5))), r = {}, q = this.labelMetrics(),
          n = f.style && f.style.textOverflow, w, E, H = 0, t;
        D(f.rotation) || (r.rotation = f.rotation || 0);
        l(b, function (a) {
          (a = c[a]) && a.label && a.label.textPxLength > H && (H = a.label.textPxLength)
        });
        this.maxLabelLength = H;
        if (this.autoRotation) H > e && H > q.h ? r.rotation = this.labelRotation : this.labelRotation = 0; else if (x && (w = e, !n)) for (E = "clip", e = b.length; !h && e--;) if (t = b[e], t = c[t].label) t.styles && "ellipsis" ===
        t.styles.textOverflow ? t.css({textOverflow: "clip"}) : t.textPxLength > x && t.css({width: x + "px"}), t.getBBox().height > this.len / b.length - (q.h - q.f) && (t.specificTextOverflow = "ellipsis");
      ...
      addTitle: function (a) {
        var d = this.chart.renderer, b = this.horiz, k = this.opposite, c = this.options.title, f;
        this.axisTitle || ((f = c.textAlign) || (f = (b ? {low: "left", middle: "center", high: "right"} : {
          low: k ? "right" : "left",
          middle: "center", high: k ? "left" : "right"
      ...
      getOffset: function () {
        var a = this, d = a.chart, b = d.renderer, c = a.options, f = a.tickPositions,
          h = a.ticks, x = a.horiz, e = a.side, r = d.inverted && !a.isZAxis ? [1, 0, 3, 2][e] : e, n, w, E = 0, D,
          H = 0, t = c.title, K = c.labels, g = 0, J = d.axisOffset, d = d.clipOffset, m = [-1, 1, 1, -1][e],
          y = c.className, v = a.axisParent, u = this.tickSize("tick");
        n = a.hasData();
        a.showAxis = w = n || F(c.showEmpty, !0);
        a.staggerLines = a.horiz && K.staggerLines;
        a.axisGroup || (a.gridGroup = b.g("grid").attr({zIndex: c.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (y || "")).add(v), a.axisGroup = b.g("axis").attr({zIndex: c.zIndex || 2}).addClass("highcharts-" +
          this.coll.toLowerCase() + " " + (y || "")).add(v), a.labelGroup = b.g("axis-labels").attr({zIndex: K.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (y || "")).add(v));
      ...
      getLinePath: function (a) {
        var d = this.chart, b = this.opposite, k = this.offset, c = this.horiz,
          f = this.left + (b ? this.width : 0) + k, k = d.chartHeight - this.bottom - (b ? this.height : 0) + k;
        b && (a *= -1);
      ...
      getTitlePosition: function () {
        var a = this.horiz, d = this.left, b = this.top, c = this.len, f = this.options.title, h = a ? d : b,
          x = this.opposite, e = this.offset, r = f.x || 0, n = f.y || 0, q = this.axisTitle,
          w = this.chart.renderer.fontMetrics(f.style && f.style.fontSize, q),
          q = Math.max(q.getBBox(null, 0).height - w.h - 1, 0),
          c = {low: h + (a ? 0 : c), middle: h + c / 2, high: h + (a ? c : 0)}[f.align],
          d = (a ? b + this.height : d) + (a ? 1 : -1) * (x ? -1 : 1) * this.axisTitleMargin + [-q,
            q, w.f, -q][this.side];
        return {x: a ? c + r : d + (x ? this.width : 0) + e + r, y: a ? d + n - (x ? this.height : 0) + e : c + n}
      },
      renderMinorTick: function (a) {
        var d = this.chart.hasRendered && w(this.oldMin), b = this.minorTicks;
        b[a] || (b[a] = new H(this, a, "minor"));
        d && b[a].isNew && b[a].render(null, !0);
        b[a].render(null, !1, 1)
      },
      renderTick: function (a, d) {
        var b = this.isLinked, k = this.ticks, c = this.chart.hasRendered && w(this.oldMin);
        if (!b || a >= this.min && a <= this.max) k[a] || (k[a] = new H(this, a)), c && k[a].isNew && k[a].render(d, !0, .1), k[a].render(d)
      },
      render: function () {
        var b =
            this, c = b.chart, f = b.options, h = b.isLog, x = b.isLinked, r = b.tickPositions, n = b.axisTitle,
          E = b.ticks, D = b.minorTicks, t = b.alternateBands, K = f.stackLabels, F = f.alternateGridColor,
          g = b.tickmarkOffset, J = b.axisLine, m = b.showAxis, y = C(c.renderer.globalAnimation), v, u;
        ...
        J && (J[J.isPlaced ? "animate" : "attr"]({d: this.getLinePath(J.strokeWidth())}), J.isPlaced = !0, J[m ? "show" : "hide"](!0));
      ...
      destroy: function (a) {
        var d = this, b = d.stacks, k = d.plotLinesAndBands, f;
      ...
      drawCrosshair: function (a, d) {
        var b, c = this.crosshair, k = F(c.snap, !0), f, h = this.cross;
        e(this, "drawCrosshair", {e: a, point: d});
        ...
        if (this.crosshair && !1 !== (z(d) || !k)) {
          ...
          h || (this.cross = h = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (k ? "category " : "thin ") + c.className).attr({zIndex: F(c.zIndex, 2)}).add(), h.attr({
            stroke: c.color || (k ? m("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
            "stroke-width": F(c.width, 1)
          }).css({"pointer-events": "none"}), c.dashStyle && h.attr({dashstyle: c.dashStyle}));
          h.show().attr({d: b});
          k && !c.width && h.attr({"stroke-width": this.transA});
          this.cross.e = a
        } else this.hideCrosshair();
        e(this, "afterDrawCrosshair", {e: a, point: d})
      },
  ...
  (function (a) {
    ...
    B.prototype.normalizeTimeTickInterval = function (a, g) {
      ...
      return {unitRange: z, count: a, unitName: g[0]}
    }
  })(L);
  (function (a) {
    var B = a.Axis, C = a.getMagnitude, G = a.map, p = a.normalizeTickInterval,
      m = a.pick;
    B.prototype.getLogTickPositions = function (a, v, z, u) {
      var g = this.options, l = this.len, b = [];
  ...
  (function (a, B) {
    var C = a.arrayMax, G = a.arrayMin, p = a.defined, m = a.destroyObjectProperties, g = a.each, v = a.erase, z =
      a.merge, u = a.pick;
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        var g = this, l = g.axis, b = l.horiz, e = g.options, t = e.label, n = g.label, f = e.to, c = e.from,
          h = e.value, w = p(c) && p(f), D = p(h), r = g.svgElem, J = !r, q = [], F = e.color, x = u(e.zIndex, 0),
          K = e.events, q = {"class": "highcharts-plot-" + (w ? "band " : "line ") + (e.className || "")}, d = {},
          H = l.chart.renderer, E = w ? "bands" : "lines";
        l.isLog && (c = l.log2lin(c), f = l.log2lin(f), h = l.log2lin(h));
        D ? (q = {stroke: F, "stroke-width": e.width},
        ...
        if (D) q = l.getPlotLinePath(h, r.strokeWidth()); else if (w) q = l.getPlotBandPath(c, f, e); else return;
        J && q && q.length ? (r.attr({d: q}), K && a.objectEach(K, function (a, d) {
          r.on(d, function (a) {
            K[d].apply(g, [a])
          })
        })) : r && (q ? (r.show(),
          r.animate({d: q})) : (r.hide(), n && (g.label = n = n.destroy())));
        ...
        var t = this.label, n = this.axis.chart.renderer;
        t || (t = {
        ...
        b = G(e);
        n = G(l);
        t.align(a, !1, {x: b, y: n, width: C(e) - b, height: C(l) - n});
        t.show()
      }, destroy: function () {
    ...
    a.extend(B.prototype, {
      getPlotBandPath: function (a, l) {
        var b = this.getPlotLinePath(l, null, null, !0), e = this.getPlotLinePath(a, null, null, !0), t = [],
          n = this.horiz, f = 1, c;
        a = a < this.min && l < this.min || a > this.max && l > this.max;
        if (e &&
          b) for (a && (c = e.toString() === b.toString(), f = 0), a = 0; a < e.length; a += 6) n && b[a + 1] === e[a + 1] ? (b[a + 1] += f, b[a + 4] += f) : n || b[a + 2] !== e[a + 2] || (b[a + 2] += f, b[a + 5] += f), t.push("M", e[a + 1], e[a + 2], "L", e[a + 4], e[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"), t.flat = c;
        return t
        ...
        var b = (new a.PlotLineOrBand(this, g)).render(), e = this.userOptions;
        b && (l && (e[l] = e[l] || [],
  ...
  (function (a) {
    var B = a.each, C = a.extend, G = a.format, p = a.isNumber,
      m = a.map, g = a.merge, v = a.pick, z = a.splat, u = a.syncTimeout, y = a.timeUnits;
    a.Tooltip = function () {
      this.init.apply(this, arguments)
    };
    a.Tooltip.prototype = {
      init: function (a, b) {
        ...
        var e, l = this.chart, n = l.inverted, f = l.plotTop, c = l.plotLeft, h = 0, w = 0, D, r;
        a = z(a);
        e = a[0].tooltipPos;
        ...
        var l = this.chart, n = this.distance, f = {}, c = l.inverted && e.h || 0, h,
          w = ["y", l.chartHeight, b, e.plotY + l.plotTop, l.plotTop, l.plotTop + l.plotHeight],
          D = ["x", l.chartWidth, a, e.plotX + l.plotLeft, l.plotLeft, l.plotLeft + l.plotWidth],
          r = !this.followPointer && v(e.ttBelow, !l.inverted ===
            !!e.negative), g = function (a, d, b, h, k, x) {
            var e = b < h - n, q = h + n + b < d, w = h - n - b;
            h += n;
            if (r && q) f[a] = h; else if (!r && e) f[a] = w; else if (e) f[a] = Math.min(x - b, 0 > w - c ? w : w - c); else if (q) f[a] = Math.max(k, h + c + b > d ? h : h + c); else return !1
          }, q = function (a, d, b, c) {
            var k;
        ...
        var e, t = this.options, n, f = l, c, h = {}, w = [];
        ...
        t.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = z(f)[0].series.tooltipOptions.followPointer, c = this.getAnchor(f, b), b = c[0], n = c[1], !h || f.series && f.series.noSharedTooltip ? h = f.getLabelConfig() : (B(f, function (a) {
          ...
          h = {
            x: f[0].category,
            y: f[0].y
          }, h.points = w, f = f[0]), this.len = w.length, h = e.call(h, this), D = f.series, this.distance = v(D.tooltipOptions.distance, 16), !1 === h ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({opacity: 1}).show(), this.split ? this.renderSplit(h, z(l)) : (t.style.width || e.css({width: this.chart.spacingBox.width}), e.attr({text: h && h.join ? h.join("") : h}), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + v(f.colorIndex, D.colorIndex)), e.attr({
        ...
        var e = this, t = [], n = this.chart, f = n.renderer, c = !0, h = this.options, w = 0, D = this.getLabel();
        a.isString(l) && (l = [!1, l]);
        B(l.slice(0, b.length + 1), function (a, l) {
          if (!1 !== a) {
            l = b[l - 1] || {isHeader: !0, plotX: b[0].plotX};
            var r = l.series || e, F = r.tt, x = l.series || {},
            ...
            t.push({
              target: l.isHeader ? n.plotHeight +
                w : a, rank: l.isHeader ? 1 : 0, size: r.tt.getBBox().height + 1, point: l, x: x, tt: F
            })
          }
        });
        this.cleanSplit();
        ...
        var b = this.chart, e = this.getLabel(), e = (this.options.positioner ||
        ...
        var n = this.chart.time, f = n.dateFormat("%m-%d %H:%M:%S.%L", b), c, h,
          w = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, l = "millisecond";
        for (h in y) {
        ...
        b = b ? "footer" : "header";
        var e = a.series, l = e.tooltipOptions, n = l.xDateFormat, f = e.xAxis,
          c = f && "datetime" === f.options.type && p(a.key), h = l[b + "Format"];
        c && !n && (n = this.getXDateFormat(a, l, f));
        c && n && B(a.point && a.point.tooltipDateKeys || ["key"], function (a) {
          h = h.replace("{point." + a + "}", "{point." +
            a + ":" + n + "}")
        });
        return G(h, {point: a, series: e}, this.chart.time)
  ...
  (function (a) {
    var B = a.addEvent, C = a.attr, G = a.charts, p = a.color, m = a.css, g = a.defined, v = a.each, z = a.extend,
      u = a.find, y = a.fireEvent, l = a.isNumber, b = a.isObject, e = a.offset, t = a.pick, n = a.splat, f = a.Tooltip;
    ...
    a.Pointer.prototype = {
      init: function (a, b) {
        ...
        return z(a, {chartX: Math.round(c.pageX - b.left), chartY: Math.round(c.pageY - b.top)})
        ...
        v(a, function (a) {
          var h =
            !(a.noSharedTooltip && f) && 0 > a.options.findNearestPointBy.indexOf("y");
          a = a.searchPoint(e, h);
          if ((h = b(a, !0)) && !(h = !b(c, !0))) var h = c.distX - a.distX, n = c.dist - a.dist,
        ...
        var c = a.series, f = c.xAxis, c = c.yAxis, h =
          t(a.clientX, a.plotX), e = a.shapeArgs;
        if (f && c) return b ? {chartX: f.len + f.pos - h, chartY: c.len + c.pos - a.plotY} : {
          chartX: h + f.pos,
          chartY: a.plotY + c.pos
        };
        if (e && e.x && e.y) return {chartX: e.x, chartY: e.y}
      }, getHoverData: function (c, f, e, n, r, l, q) {
        var h, x = [], w = q && q.isBoosting;
        n = !(!n || !c);
        ...
        return {hoverPoint: h, hoverSeries: f, hoverPoints: x}
      }, runPointActions: function (b, f) {
        var c = this.chart, h = c.tooltip && c.tooltip.options.enabled ? c.tooltip : void 0, e = h ? h.shared : !1,
          n = f || c.hoverPoint, q = n && n.series || c.hoverSeries,
          q = this.getHoverData(n, q, c.series, !!f || q && q.directTouch && this.isDirectTouch, e,
            b, {isBoosting: c.isBoosting}), l, n = q.hoverPoint;
        l = q.hoverPoints;
        ...
        var b = this.chart, c = b.options.chart, f = a.chartX, e = a.chartY, n = this.zoomHor, q = this.zoomVert,
          l = b.plotLeft,
          x = b.plotTop, t = b.plotWidth, d = b.plotHeight, H, E = this.selectionMarker, k = this.mouseDownX,
          A = this.mouseDownY, g = c.panKey && a[c.panKey + "Key"];
        E && E.touch || (f < l ? f = l : f > l + t && (f = l + t), e < x ? e = x : e > x + d && (e = x + d), this.hasDragged = Math.sqrt(Math.pow(k - f, 2) + Math.pow(A - e, 2)), 10 < this.hasDragged && (H = b.isInsidePlot(k - l, A - x), b.hasCartesianSeries && (this.zoomX || this.zoomY) && H && !g && !E && (this.selectionMarker = E = b.renderer.rect(l, x, n ? 1 : t, q ? 1 : d, 0).attr({
          fill: c.selectionMarkerFill || p("#335cad").setOpacity(.25).get(), "class": "highcharts-selection-marker",
          zIndex: 7
        }).add()), E && n && (f -= k, E.attr({
          width: Math.abs(f),
          x: (0 < f ? 0 : f) + k
        ...
        if (this.selectionMarker) {
          var e = {originalEvent: a, xAxis: [], yAxis: []}, n = this.selectionMarker, q = n.attr ? n.attr("x") : n.x,
            t = n.attr ? n.attr("y") : n.y, x = n.attr ? n.attr("width") : n.width,
            K = n.attr ? n.attr("height") : n.height, d;
          if (this.hasDragged || f) v(c.axes, function (c) {
            if (c.zoomEnabled && g(c.min) &&
              (f || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
              var h = c.horiz, k = "touchend" === a.type ? c.minPixelPadding : 0, n = c.toValue((h ? q : t) + k),
                h = c.toValue((h ? q + x : t + K) - k);
              e[c.coll].push({axis: c, min: Math.min(n, h), max: Math.max(n, h)});
              d = !0
            }
          }), d && y(c, "selection", e, function (a) {
            c.zoom(z(a, f ? {animation: !1} : null))
          });
          l(c.index) && (this.selectionMarker = this.selectionMarker.destroy());
          f && this.scaleGroups()
        }
        c && l(c.index) && (m(c.container, {cursor: c._cursor}), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown = this.hasDragged = this.hasPinched =
          !1, this.pinchDown = [])
        ...
        a = this.normalize(a);
        b.cancelClick ||
        (f && this.inClass(a.target, "highcharts-tracker") ? (y(f.series, "click", z(a, {point: f})), b.hoverPoint && f.firePointEvent("click", a)) : (z(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - e) && y(b, "click", a)))
      }, setDOMEvents: function () {
        var b = this, f = b.chart.container, e = f.ownerDocument;
  ...
  (function (a) {
    var B = a.charts, C = a.each, G = a.extend, p = a.map, m = a.noop, g = a.pick;
    G(a.Pointer.prototype, {
      pinchTranslate: function (a, g, m, p, l, b) {
        ...
        var n = this.chart, f = a ? "x" : "y", c = a ? "X" : "Y", h = "chart" + c, w = a ? "width" :
          "height", D = n["plot" + (a ? "Left" : "Top")], r, J, q = t || 1, F = n.inverted, x = n.bounds[a ? "h" : "v"],
          K = 1 === g.length, d = g[0][h], H = m[0][h], E = !K && g[1][h], k = !K && m[1][h], A;
        m = function () {
        ...
        var v =
            this, u = v.chart, y = v.pinchDown, l = a.touches, b = l.length, e = v.lastValidTouch, t = v.hasZoom,
          n = v.selectionMarker, f = {},
          c = 1 === b && (v.inClass(a.target, "highcharts-tracker") && u.runTrackerClick || v.runChartClick), h = {};
        1 < b && (v.initiated = !0);
        ...
        "touchstart" === a.type ? (C(l, function (a, b) {
          ...
          if (a.zoomEnabled) {
            var b =
                u.bounds[a.horiz ? "h" : "v"], f = a.minPixelPadding, c = a.toPixels(g(a.options.min, a.dataMin)),
              h = a.toPixels(g(a.options.max, a.dataMax)), e = Math.max(c, h);
  ...
  (function (a) {
    var B = a.addEvent, C = a.charts, G = a.css, p = a.doc, m = a.extend, g = a.noop, v = a.Pointer, z = a.removeEvent,
      u = a.win, y = a.wrap;
    if (!a.hasTouch && (u.PointerEvent || u.MSPointerEvent)) {
      var l = {}, b = !!u.PointerEvent, e = function () {
        var b = [];
        b.item = function (a) {
          return this[a]
        };
      ...
      y(v.prototype, "init", function (a, b, c) {
        a.call(this, b, c);
        this.hasZoom &&
        G(b.container, {"-ms-touch-action": "none", "touch-action": "none"})
      });
  ...
  (function (a) {
    var B = a.addEvent, C = a.css, G = a.discardElement, p = a.defined, m = a.each, g = a.fireEvent, v = a.isFirefox,
      z = a.marginNames, u = a.merge, y = a.pick, l = a.setAnimation, b = a.stableSort, e = a.win, t = a.wrap;
    ...
    a.Legend.prototype =
      {
        init: function (a, b) {
          ...
          var f = this.options, h = a.legendItem, e = a.legendLine, n = a.legendSymbol, l = this.itemHiddenStyle.color,
            f = b ? f.itemStyle.color : l, t = b ? a.color || l : l, q = a.options && a.options.marker, F = {fill: t};
          ...
          var b = this.options, c = b.symbolPadding, b = !b.rtl, h = a._legendItemPos, e = h[0], h = h[1],
            n = a.checkbox;
          ...
          var a = this.group && this.group.alignAttr, b, c = this.clipHeight || this.legendHeight, h = this.titleHeight;
          ...
          var a = this.options, b = this.padding,
            c = a.title, h = 0;
          c.text && (this.title || (this.title = this.chart.renderer.label(c.text, b - 3, b - 4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}).css(c.style).add(this.group)), a = this.title.getBBox(), h = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: h}));
          this.titleHeight = h
        }, setText: function (b) {
          var f = this.options;
          b.legendItem.attr({text: f.labelFormat ? a.format(f.labelFormat, b, this.chart.time) : f.labelFormatter.call(b)})
        }, renderItem: function (a) {
          var b = this.chart, c = b.renderer, h =
              this.options, e = this.symbolWidth, l = h.symbolPadding, n = this.itemStyle, t = this.itemHiddenStyle,
            q = "horizontal" === h.layout ? y(h.itemDistance, 20) : 0, g = !h.rtl, x = a.legendItem, K = !a.series,
            d = !K && a.series.drawLegendSymbol ? a.series : a, H = d.options,
            H = this.createCheckboxForItem && H && H.showCheckbox, q = e + l + q + (H ? 20 : 0), E = h.useHTML,
            k = a.options.className;
          x || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + d.type + "-series highcharts-color-" + a.colorIndex + (k ? " " + k : "") + (K ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup),
          ...
          var b = this.options, c = this.padding, h = "horizontal" === b.layout, e = a.itemHeight,
            l = b.itemMarginBottom || 0, n = this.itemMarginTop, t = h ? y(b.itemDistance, 20) : 0, q = b.width,
            g = q || this.chart.spacingBox.width -
              2 * c - b.x, b = b.alignColumns && this.totalItemWidth > g ? this.maxItemWidth : a.itemWidth;
          ...
          var c = this.chart, f = this.options, e = this.getAlignment();
          ...
          var a = this.chart, f = a.renderer, c = this.group, e, l, t, r, g = this.box, q = this.options,
            F = this.padding;
          this.itemX = F;
          this.itemY = this.initialItemY;
          this.lastItemY = this.offsetWidth = 0;
          c || (this.group = c = f.g("legend").attr({zIndex: 7}).add(), this.contentGroup = f.g().attr({zIndex: 1}).add(c), this.scrollGroup = f.g().add(this.contentGroup));
          this.renderTitle();
          e = this.getAllItems();
          b(e, function (a, b) {
          ...
          r += F;
          g || (this.box = g = f.rect().addClass("highcharts-legend-box").attr({r: q.borderRadius}).add(c),
            g.isNew = !0);
          g.attr({
          ...
          l && (f = a.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) && (f = u(f, {y: f.y + a.titleOffset + a.options.title.margin})), c.align(u(q, {
            width: t,
            height: r
          }), !0, f));
        ...
        handleOverflow: function (a) {
          var b = this, c = this.chart, e = c.renderer, l = this.options, n = l.y, r = this.padding,
            c = c.spacingBox.height + ("top" === l.verticalAlign ? -n : n) - r, n = l.maxHeight, t, q = this.clipRect,
            g = l.navigation, x = y(g.animation, !0), K = g.arrowSize || 12, d = this.nav, H = this.pages, E,
            k = this.allItems, A = function (a) {
          ...
          a > c && !1 !== g.enabled ? (this.clipHeight = t = Math.max(c - 20 - this.titleHeight - r, 0), this.currentPage = y(this.currentPage, 1), this.fullHeight = a, m(k, function (a, b) {
            var d = a._legendItemPos[1], c = Math.round(a.legendItem.getBBox().height), f = H.length;
            ...
            0), b.contentGroup.clip(q)), A(t), d || (this.nav = d = e.g().attr({zIndex: 1}).add(this.group), this.up = e.symbol("triangle", 0, 0, K, K).on("click", function () {
            b.scroll(-1, x)
            ...
            b.scroll(1, x)
          }).add(d)), b.scroll(0), a = c) : d && (A(), this.nav = d.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
          return a
        }, scroll: function (a, b) {
          var c = this.pages, f =
            c.length;
          a = this.currentPage + a;
          var e = this.clipHeight, n = this.options.navigation, r = this.pager, t = this.padding;
          a > f && (a = f);
          0 < a && (void 0 !== b && l(b, this.chart), this.nav.attr({
            translateX: t,
            translateY: e + this.padding + 7 + this.titleHeight,
            visibility: "visible"
          }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), r.attr({text: a + "/" + f}), this.down.attr({
            x: 18 + this.pager.getBBox().width,
            "class": a === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
          }), this.up.attr({
            fill: 1 ===
            a ? n.inactiveColor : n.activeColor
          }).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === f ? n.inactiveColor : n.activeColor}).css({cursor: a === f ? "default" : "pointer"}), this.scrollOffset = -c[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = a, this.positionCheckboxes())
        }
      };
    a.LegendSymbolMixin = {
      drawRectangle: function (a, b) {
        ...
        b.legendSymbol = this.chart.renderer.rect(f ? (a.symbolWidth - c) / 2 : 0, a.baseline - c + 1, f ? c : a.symbolWidth,
          c, y(a.options.symbolRadius, c / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(b.legendGroup)
      }, drawLineMarker: function (a) {
        var b = this.options, c = b.marker, e = a.symbolWidth, l = a.symbolHeight, n = l / 2, r = this.chart.renderer,
          t = this.legendGroup;
  ...
  (function (a) {
    var B = a.addEvent, C = a.animate, G = a.animObject, p = a.attr, m = a.doc, g = a.Axis, v = a.createElement,
      z = a.defaultOptions, u = a.discardElement, y = a.charts, l = a.css, b = a.defined, e = a.each,
      t = a.extend, n = a.find, f = a.fireEvent, c = a.grep, h = a.isNumber, w = a.isObject, D = a.isString,
      r = a.Legend, J = a.marginNames, q = a.merge, F = a.objectEach, x = a.Pointer, K = a.pick, d = a.pInt,
      H = a.removeEvent, E = a.seriesTypes, k = a.splat, A = a.syncTimeout, P = a.win, R = a.Chart = function () {
    ...
    t(R.prototype, {
      ...
      isInsidePlot: function (a, b, d) {
        ...
        f(this, "beforeRedraw");
        var d = this.axes, k = this.series, c = this.pointer, h = this.legend, x = this.isDirtyLegend, l, q,
          E = this.hasCartesianSeries, r = this.isDirtyBox, n, H = this.renderer, g = H.isHidden(), A = [];
        this.setResponsive && this.setResponsive(!1);
        a.setAnimation(b, this);
        g && this.temporaryDisplay();
        this.layOutTitles();
        for (b = k.length; b--;) if (n = k[b], n.options.stacking && (l = !0, n.isDirty)) {
          q = !0;
          break
        }
        if (q) for (b = k.length; b--;) n = k[b], n.options.stacking && (n.isDirty = !0);
        e(k, function (a) {
        ...
        var d, k = this.series, c;
        d = n(this.axes, b) || n(this.series, b);
        for (c = 0; !d && c < k.length; c++) d = n(k[c].points || [], b);
        return d
      }, getAxes: function () {
        var a =
          this, b = this.options, d = b.xAxis = k(b.xAxis || {}), b = b.yAxis = k(b.yAxis || {});
        f(this, "getAxes");
        e(d, function (a, b) {
          a.index = b;
          a.isX = !0
        ...
        c = c.subtitle = q({style: {color: "#666666"}}, c.subtitle, b);
        e([["title", a, f], ["subtitle", b, c]], function (a, b) {
          var d = a[0], c = k[d], f = a[1];
          a = a[2];
          c && f && (k[d] = c = c.destroy());
        ...
        var b = 0, d, k = this.renderer, c = this.spacingBox;
        e(["title", "subtitle"],
          function (a) {
            var d = this[a], f = this.options[a];
            a = "title" === a ? -3 : f.verticalAlign ? 0 : b + 2;
            var e;
            d && (e = f.style.fontSize, e = k.fontMetrics(e, d).b, d.css({width: (f.width || c.width + f.widthAdjust) + "px"}).align(t({y: a + e}, f), !1, "spacingBox"), f.floating || f.verticalAlign || (b = Math.ceil(b + d.getBBox(f.useHTML).height)))
          }, this);
        ...
        var d = this.options.chart,
          k = d.width, d = d.height, c = this.renderTo;
        ...
        var d = this.renderTo;
        if (b) for (; d && d.style;) d.hcOrigStyle && (a.css(d, d.hcOrigStyle), delete d.hcOrigStyle), d.hcOrigDetached && (m.body.removeChild(d), d.hcOrigDetached =
          !1), d = d.parentNode; else for (; d && d.style;) {
        ...
        var b, k = this.options, c = k.chart, e, x;
        b = this.renderTo;
        var l = a.uniqueKey(), q;
        ...
        x = this.chartHeight;
        q = t({
          position: "relative", overflow: "hidden", width: e + "px", height: x +
          "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"
        }, c.style);
        this.container = b = v("div", {id: l}, q, b);
        ...
        var d = this.spacing, k = this.margin, c = this.titleOffset;
        this.resetMargins();
        c &&
        ...
        var a = this, d = a.axisOffset = [0, 0, 0, 0], k = a.margin;
        ...
        var k = this, c = k.options.chart, f = k.renderTo, e = b(c.width) && b(c.height),
          h = c.width || a.getStyle(f, "width"), c = c.height || a.getStyle(f, "height"), f = d ? d.target : P;
        ...
        c.getChartSize();
        b = h.globalAnimation;
        (b ? C : l)(c.container, {width: c.chartWidth + "px", height: c.chartHeight + "px"}, b);
        c.setChartSize(!0);
        ...
        var b = this.inverted, d = this.renderer, c = this.chartWidth, k = this.chartHeight, h = this.options.chart,
          x = this.spacing, l = this.clipOffset, q, E, r, n;
        ...
        this.spacingBox = d.spacingBox = {x: x[3], y: x[0], width: c - x[3] - x[1], height: k - x[0] - x[2]};
        this.plotBox = d.plotBox = {x: q, y: E, width: r, height: n};
        c = 2 * Math.floor(this.plotBorderWidth / 2);
        b = Math.ceil(Math.max(c, l[3]) / 2);
        d = Math.ceil(Math.max(c, l[0]) / 2);
        this.clipBox = {
          x: b, y: d, width: Math.floor(this.plotSizeX - Math.max(c,
            l[1]) / 2 - b), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(c, l[2]) / 2 - d))
        };
        ...
        var a =
            this.options.chart, b = this.renderer, d = this.chartWidth, c = this.chartHeight, k = this.chartBackground,
          e = this.plotBackground, h = this.plotBorder, x, l = this.plotBGImage, q = a.backgroundColor,
          E = a.plotBackgroundColor, r = a.plotBackgroundImage, n, t = this.plotLeft, H = this.plotTop,
          g = this.plotWidth, A = this.plotHeight, K = this.plotBox, w = this.clipRect, F = this.clipBox, m = "animate";
        ...
        k[m]({x: n / 2, y: n / 2, width: d - n - x % 2, height: c - n - x % 2, r: a.borderRadius});
        m = "animate";
        e || (m = "attr", this.plotBackground = e = b.rect().addClass("highcharts-plot-background").add());
        e[m](K);
        e.attr({fill: E || "none"}).shadow(a.plotShadow);
        r && (l ? l.animate(K) : this.plotBGImage = b.image(r, t, H, g, A).add());
        w ? w.animate({width: F.width, height: F.height}) : this.clipRect = b.clipRect(F);
        m = "animate";
        h || (m = "attr", this.plotBorder = h = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
        h.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
        h[m](h.crisp({x: t, y: H, width: g, height: A}, -h.strokeWidth()));
        this.isDirtyBox = !1;
        f(this, "afterDrawChartBox")
      }, propFromSeries: function () {
        var a = this, b = a.options.chart, d, c = a.options.series, k, f;
        ...
        b.items && e(b.items, function (c) {
          var k = t(b.style, c.style), f = d(k.left) + a.plotLeft, e = d(k.top) + a.plotTop + 12;
          delete k.left;
          delete k.top;
          a.renderer.text(c.html, f, e).attr({zIndex: 2}).css(k).add()
        })
      }, render: function () {
        var a = this.axes, b = this.renderer, d = this.options, c, k, f;
        this.setTitle();
        ...
        var b = this, d = b.axes, c = b.series, k = b.container, h, x = k && k.parentNode;
        f(b, "destroy");
  ...
  (function (a) {
    var B = a.addEvent, C = a.Chart, G = a.each;
    B(C, "afterSetChartSize", function (p) {
      var m =
        this.options.chart.scrollablePlotArea;
      if (m = m && m.minWidth) if (this.scrollablePixels = m = Math.max(0, m - this.chartWidth)) this.plotWidth += m, this.clipBox.width += m, p.skipAxes || G(this.axes, function (g) {
    ...
    C.prototype.applyFixed = function () {
      ...
      this.fixedDiv || (this.fixedDiv =
        ...
        ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", ".highcharts-credits", ".highcharts-legend", ".highcharts-subtitle", ".highcharts-title"], function (g) {
      ...
      var v = this.plotTop + this.plotHeight + v[2], z = this.plotLeft + this.plotWidth - this.scrollablePixels;
      this.scrollableMask.attr({d: this.scrollablePixels ? ["M", 0, g, "L", this.plotLeft - 1, g, "L", this.plotLeft - 1, v, "L", 0, v, "Z", "M", z, g, "L", this.chartWidth, g, "L", this.chartWidth, v, "L", z, v, "Z"] : ["M", 0, 0]})
    }
  })(L);
  (function (a) {
    var B, C = a.each, G =
        a.extend, p = a.erase, m = a.fireEvent, g = a.format, v = a.isArray, z = a.isNumber, u = a.pick,
      y = a.removeEvent;
    a.Point = B = function () {
    };
    a.Point.prototype = {
      ...
      applyOptions: function (a, b) {
        var e = this.series, l = e.options.pointValKey || e.pointValKey;
      ...
      setNestedProperty: function (l, b, e) {
        ...
        var b = {}, e = this.series, t = e.options.keys, n = t || e.pointArrayMap || ["y"], f = n.length, c = 0, h = 0;
        if (z(l) || null === l) b[n[0]] = l; else if (v(l)) for (!t && l.length > f && (e = typeof l[0], "string" === e ? b.name = l[0] : "number" === e && (b.x = l[0]), c++); h < f;) t && void 0 === l[c] || (0 < n[h].indexOf(".") ? a.Point.prototype.setNestedProperty(b, l[c], n[h]) : b[n[h]] =
          l[c]), c++, h++; else "object" === typeof l && (b = l, l.dataLabels && (e._hasPointLabels = !0), l.marker && (e._hasPointMarkers = !0));
        return b
      }, getClassName: function () {
        return "highcharts-point" + (this.selected ? " highcharts-point-select" : "") + (this.negative ? " highcharts-negative" : "") + (this.isNull ? " highcharts-null-point" : "") + (void 0 !== this.colorIndex ? " highcharts-color-" + this.colorIndex : "") + (this.options.className ? " " + this.options.className : "") + (this.zone && this.zone.className ? " " + this.zone.className.replace("highcharts-negative",
          "") : "")
      }, getZone: function () {
        var a = this.series, b = a.zones, a = a.zoneAxis || "y", e = 0, t;
        for (t = b[e]; this[a] >= t.value;) t = b[++e];
        this.nonZonedColor || (this.nonZonedColor = this.color);
        this.color = t && t.color && !this.options.color ? t.color : this.nonZonedColor;
        return t
      }, destroy: function () {
        var a = this.series.chart, b = a.hoverPoints, e;
        a.pointCount--;
        ...
        var b = this.series, e = b.tooltipOptions,
          l = u(e.valueDecimals, ""), n = e.valuePrefix || "", f = e.valueSuffix || "";
        C(b.pointArrayMap || ["y"], function (b) {
          b = "{point." + b;
          if (n || f) a = a.replace(RegExp(b + "}", "g"), n + b + "}" + f);
          a = a.replace(RegExp(b + "}", "g"), b + ":,." + l + "f}")
        });
        return g(a, {point: this, series: this.series}, b.chart.time)
      }, firePointEvent: function (a, b, e) {
        var l = this, n = this.series.options;
  ...
  (function (a) {
    var B = a.addEvent, C = a.animObject, G = a.arrayMax, p = a.arrayMin, m = a.correctFloat, g = a.defaultOptions,
      v = a.defaultPlotOptions, z = a.defined, u = a.each, y = a.erase, l = a.extend, b = a.fireEvent, e = a.grep,
      t = a.isArray, n = a.isNumber, f = a.isString, c = a.merge, h = a.objectEach, w = a.pick, D = a.removeEvent,
      r = a.splat, J = a.SVGElement, q = a.syncTimeout, F = a.win;
    a.Series = a.seriesType("line", null, {
      ...
      init: function (a, c) {
        ...
        l(d, {
          name: c.name,
          state: "", visible: !1 !== c.visible, selected: !0 === c.selected
        });
        f = c.events;
        h(f, function (a, b) {
          B(d, b, a)
      ...
      updateParallelArrays: function (a, b) {
        var d = a.series, c = arguments, f = n(b) ? function (c) {
          var k = "y" === c && d.toYData ?
            d.toYData(a) : a[c];
          d[c + "Data"][b] = k
        } : function (a) {
      ...
      setOptions: function (a) {
        var f = this.chart, d = f.options, e = d.plotOptions, h = (f.userOptions || {}).plotOptions || {},
          k = e[this.type];
        this.userOptions = a;
        f = c(k, e.series, a);
        ...
        a.length && z(a[a.length - 1].value) && a.push({color: this.color, fillColor: this.fillColor});
      ...
      getCyclic: function (a, b, d) {
        var c, f = this.chart, k = this.userOptions, e = a + "Index", h = a + "Counter",
      ...
      updateData: function (b) {
        var c = this.options, d = this.points, f = [], e, k, h, x = this.requireSorting;
        u(b, function (b) {
          var k;
          k = a.defined(b) && this.pointClass.prototype.optionsToObject.call({series: this}, b).x;
          n(k) && (k = a.inArray(k, this.xData, h), -1 === k ? f.push(b) : b !== c.data[k] ? (d[k].update(b, !1, null, !1), d[k].touched = !0, x && (h = k)) : d[k] && (d[k].touched = !0), e = !0)
        }, this);
        if (e) for (b = d.length; b--;) k = d[b], k.touched || k.remove(!1),
          k.touched = !1; else if (b.length === d.length) u(b, function (a, b) {
      ...
      setData: function (b, c, d, e) {
        var h = this, k = h.points, x = k && k.length || 0, q, l = h.options, r = h.chart, g = null, H = h.xAxis,
          F = l.turboThreshold, m = this.xData, D = this.yData, K = (q = h.pointArrayMap) && q.length, J;
        b = b || [];
        q = b.length;
        c = w(c, !0);
        ...
        if (!J) {
          ...
          if (F && q > F) {
            ...
            if (n(g)) for (d = 0; d < q; d++) m[d] = this.autoIncrement(), D[d] = b[d]; else if (t(g)) if (K) for (d = 0; d < q; d++) g = b[d], m[d] = g[0], D[d] = g.slice(1, K + 1); else for (d = 0; d < q; d++) g = b[d], m[d] = g[0], D[d] = g[1]; else a.error(12)
          } else for (d = 0; d < q; d++) void 0 !== b[d] && (g = {series: h}, h.pointClass.prototype.applyOptions.apply(g, [b[d]]), h.updateParallelArrays(g, d));
      ...
      processData: function (b) {
        ...
        e = 0;
        var k, h, x = this.xAxis, q, l = this.options;
        q = l.cropThreshold;
        var r = this.getExtremesFromAll || l.getExtremesFromAll, n = this.isCartesian, l = x && x.val2lin,
          g = x && x.isLog, t = this.requireSorting, w, F;
        if (n && !this.isDirty && !x.isDirty && !this.yAxis.isDirty &&
          !b) return !1;
        x && (b = x.getExtremes(), w = b.min, F = b.max);
        if (n && this.sorted && !r && (!q || f > q || this.forceCrop)) if (c[f - 1] < w || c[0] > F) c = [], d = []; else if (c[0] < w || c[f - 1] > F) e = this.cropData(this.xData, this.yData, w, F), c = e.xData, d = e.yData, e = e.start, k = !0;
      ...
      cropData: function (a, b, d, c, f) {
        var k = a.length, e = 0, h = k, x;
        f =
          w(f, this.cropShoulder, 1);
        for (x = 0; x < k; x++) if (a[x] >= d) {
          e = Math.max(0, x - f);
          break
        }
        for (d = x; d < k; d++) if (a[d] > c) {
          h = d + f;
          break
        }
      ...
      generatePoints: function () {
        var a = this.options, b = a.data, d = this.data, c, f = this.processedXData, k = this.processedYData,
          e = this.pointClass, h = f.length, q = this.cropStart || 0, l, n = this.hasGroupedData, a = a.keys, g, t = [],
          w;
        ...
        this.options.keys = a;
        if (d && (h !== (c = d.length) || n)) for (w = 0; w < c; w++) w !== q || n || (w += h), d[w] && (d[w].destroyElements(), d[w].plotX = void 0);
        this.data = d;
        this.points = t
      },
      getExtremes: function (a) {
        var b = this.yAxis, d = this.processedXData, c, f = [], k = 0;
        c = this.xAxis.getExtremes();
        var e = c.min, h = c.max, q, x, l = this.requireSorting ? 1 : 0, r, g;
        a = a || this.stackedYData || this.processedYData || [];
        c = a.length;
        for (g = 0; g < c; g++) if (x =
          d[g], r = a[g], q = (n(r, !0) || t(r)) && (!b.positiveValuesOnly || r.length || 0 < r), x = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[g + l] || x) >= e && (d[g - l] || x) <= h, q && x) if (q = r.length) for (; q--;) "number" === typeof r[q] && (f[k++] = r[q]); else f[k++] = r;
        this.dataMin = p(f);
        this.dataMax = G(f)
      },
      translate: function () {
        ...
        this.generatePoints();
        var a = this.options, c = a.stacking, d = this.xAxis, f = d.categories, e = this.yAxis, k = this.points,
          h = k.length, q = !!this.modifyValue, l = a.pointPlacement,
          r = "between" === l || n(l), g = a.threshold, t = a.startFromThreshold ? g : 0, F, D, J, u,
          v = Number.MAX_VALUE;
        "between" === l && (l = .5);
        n(l) && (l *= w(a.pointRange || d.pointRange));
        for (a = 0; a < h; a++) {
          var p = k[a], y = p.x, C = p.y;
          D = p.low;
          var B = c && e.stacks[(this.negStacks && C < (t ? 0 : g) ? "-" : "") + this.stackKey], G;
      ...
      setClip: function (a) {
        var b = this.chart, d = this.options, c = b.renderer, f = b.inverted, k = this.clipBox, e = k || b.clipBox,
          h = this.sharedClipKey ||
            ["_sharedClip", a && a.duration, a && a.easing, e.height, d.xAxis, d.yAxis].join(), q = b[h],
          l = b[h + "m"];
        q || (a && (e.width = 0, f && (e.x = b.plotSizeX), b[h + "m"] = l = c.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[h] = q = c.clipRect(e), q.count = {length: 0});
      ...
      animate: function (a) {
        var b = this.chart, d = C(this.options.animation), c;
      ...
      drawPoints: function () {
        var a = this.points, b = this.chart, d, c, f, k, e = this.options.marker,
          h, q, l, r = this[this.specialGroup] || this.markerGroup, g,
          n = w(e.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold * e.radius);
        if (!1 !== e.enabled || this._hasPointMarkers) for (d = 0; d < a.length; d++) c = a[d], k = c.graphic, h = c.marker || {}, q = !!c.marker, f = n && void 0 === h.enabled || h.enabled, l = c.isInside, f && !c.isNull ? (f = w(h.symbol, this.symbol), g = this.markerAttribs(c, c.selected && "select"), k ? k[l ? "show" : "hide"](!0).animate(g) : l && (0 < g.width || c.hasImage) && (c.graphic = k = b.renderer.symbol(f, g.x, g.y, g.width,
      ...
      markerAttribs: function (a, b) {
        var d = this.options.marker, c = a.marker || {}, f = c.symbol || d.symbol, k = w(c.radius, d.radius);
      ...
      pointAttribs: function (a,
                              b) {
        var d = this.options.marker, c = a && a.options, f = c && c.marker || {}, k = this.color, e = c && c.color,
          h = a && a.color, c = w(f.lineWidth, d.lineWidth);
      ...
      destroy: function () {
        var c = this, f = c.chart, d = /AppleWebKit\/533/.test(F.navigator.userAgent),
          e, q, k = c.data || [], l, r;
        b(c, "destroy");
        D(c);
      ...
      getGraphPath: function (a, b,
                              d) {
        var c = this, f = c.options, k = f.step, e, h = [], q = [], l;
        a = a || c.points;
        (e = a.reversed) && a.reverse();
        (k = {right: 1, center: 2}[k] || k && 3) && e && (k = 4 - k);
        !f.connectNulls || b || d || (a = this.getValidPoints(a));
        u(a, function (e, r) {
          var x = e.plotX, g = e.plotY, n = a[r - 1];
          ...
          e.isNull && !z(b) && 0 < r ? l = !f.connectNulls : e.isNull && !b ? l = !0 : (0 === r || l ? r = ["M", e.plotX, e.plotY] : c.getPointSpline ? r = c.getPointSpline(a, e, r) : k ? (r = 1 === k ? ["L", n.plotX, g] : 2 === k ? ["L", (n.plotX + x) / 2, n.plotY, "L", (n.plotX + x) / 2, g] : ["L", x,
            n.plotY], r.push("L", x, g)) : r = ["L", x, g], q.push(e.x), k && (q.push(e.x), 2 === k && q.push(e.x)), h.push.apply(h, r), l = !1)
        });
        h.xMap = q;
      ...
      drawGraph: function () {
        var a = this, b = this.options, d = (this.gappedPath || this.getGraphPath).call(this),
          c = [["graph", "highcharts-graph", b.lineColor || this.color, b.dashStyle]], c = a.getZonesGraphs(c);
        u(c, function (c, f) {
          var k = c[0], e = a[k];
          e ? (e.endX = a.preventGraphAnimation ? null : d.xMap, e.animate({d: d})) : d.length && (a[k] = a.chart.renderer.path(d).addClass(c[1]).attr({zIndex: 1}).add(a.group),
            e = {
              stroke: c[2],
      ...
      applyZones: function () {
        var a = this,
          b = this.chart, d = b.renderer, c = this.zones, f, k, e = this.clips || [], h, q = this.graph, l = this.area,
          r = Math.max(b.chartWidth, b.chartHeight), g = this[(this.zoneAxis || "y") + "Axis"], n, t, F = b.inverted, D,
          m, J, p, v = !1;
        c.length && (q || l) && g && void 0 !== g.min && (t = g.reversed, D = g.horiz, q && !this.showLine && q.hide(), l && l.hide(), n = g.getExtremes(), u(c, function (c, x) {
          ...
          J = Math.min(f, k);
          p = Math.max(f, k);
          g.isXAxis ? (h = {x: F ? p : J, y: 0, width: m, height: r}, D || (h.x = b.plotHeight - h.x)) : (h = {
            x: 0,
            y: F ? p : J,
            width: r,
            height: m
      ...
      plotGroup: function (a, b, d, c, f) {
        var k = this[a], e = !k;
        e && (this[a] = k = this.chart.renderer.g().attr({zIndex: c || .1}).add(f));
        ...
        k.attr({visibility: d})[e ? "attr" : "animate"](this.getPlotBox());
        return k
      },
      getPlotBox: function () {
      ...
      render: function () {
        var a = this, c = a.chart, d, f = a.options, e = !!a.animate && c.renderer.isSVG && C(f.animation).duration,
          k = a.visible ? "inherit" :
            "hidden", h = f.zIndex, l = a.hasRendered, r = c.seriesGroup, g = c.inverted;
      ...
      redraw: function () {
        ...
        d && (a.inverted && d.attr({
          width: a.plotWidth,
          height: a.plotHeight
        }), d.animate({translateX: w(c && c.left, a.plotLeft), translateY: w(f && f.top, a.plotTop)}));
        this.translate();
        this.render();
      ...
      searchPoint: function (a, b) {
        ...
        return this.searchKDTree({
          clientX: f ?
            d.len - a.chartY + d.pos : a.chartX - d.pos, plotY: f ? c.len - a.chartX + c.pos : a.chartY - c.pos
        }, b)
      },
      buildKDTree: function () {
        function a(d, c, f) {
          ...
          if (e = d && d.length) return k = b.kdAxisArray[c % f], d.sort(function (a, b) {
            return a[k] - b[k]
          }), e = Math.floor(e / 2), {point: d[e], left: a(d.slice(0, e), c + 1, f), right: a(d.slice(e + 1), c + 1, f)}
        }
      ...
      searchKDTree: function (a, b) {
        function d(a, b, h, q) {
          var l = b.point, r = c.kdAxisArray[h % q], g, n, t = l;
        ...
        var c = this, f = this.kdAxisArray[0], k = this.kdAxisArray[1],
          e = b ? "distX" : "dist";
  ...
  (function (a) {
    var B = a.Axis, C = a.Chart, G = a.correctFloat, p = a.defined, m = a.destroyObjectProperties, g = a.each,
      v = a.format, z = a.objectEach, u = a.pick, y = a.Series;
    ...
    a.StackItem.prototype = {
      destroy: function () {
        ...
        var b = this.axis.chart, e = this.options, l = e.format, l = l ? v(l, this, b.time) : e.formatter.call(this);
        ...
        var e = this.axis, l = e.chart, g = e.translate(e.usePercentage ? 100 : this.total, 0, 0, 0, 1),
          f = e.translate(0), f = Math.abs(g - f);
        ...
        var h = b.axis.reversed, l = a.inverted;
        a = c.height + c.pos - a.plotTop;
        b = b.isNegative &&
          !h || !b.isNegative && h;
        return {x: l ? b ? g : g - f : e, y: l ? a - e - n : b ? a - g - f : a - g, width: l ? f : n, height: l ? n : f}
      }
    };
    ...
    B.prototype.buildStacks = function () {
      var a = this.series, b = u(this.options.reversedStacks, !0), e = a.length, g;
      if (!this.isXAxis) {
    ...
    B.prototype.renderStackTotals = function () {
      var a = this.chart, b = a.renderer, e = this.stacks, g = this.stackTotalGroup;
      g || (this.stackTotalGroup = g = b.g("stack-labels").attr({visibility: "visible", zIndex: 6}).add());
    ...
    y.prototype.setStackedPoints = function () {
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        var l = this.processedXData, b = this.processedYData, e = [], g = b.length, n = this.options, f = n.threshold,
          c = u(n.startFromThreshold && f, 0), h = n.stack, n = n.stacking, w = this.stackKey,
          D = "-" + w, r = this.negStacks, m = this.yAxis, q = m.stacks, F = m.oldStacks, x, v, d, H, E, k, A;
        m.stacksTouched += 1;
    ...
    y.prototype.modifyStacks = function () {
      var a = this, b = a.stackKey, e = a.yAxis.stacks, t = a.processedXData,
        n, f = a.options.stacking;
      a[f + "Stacker"] && g([b, "-" + b], function (b) {
        for (var c = t.length, l, g; c--;) if (l = t[c], n = a.getStackIndicator(n, l, a.index, b), g = (l = e[b] && e[b][l]) && l.points[n.key]) a[f + "Stacker"](g, l, c)
      })
    };
    ...
    y.prototype.getStackIndicator = function (a, b, e, g) {
      !p(a) || a.x !== b || g && a.key !== g ? a = {x: b, index: 0, key: g} : a.index++;
  ...
  (function (a) {
    var B = a.addEvent,
      C = a.animate, G = a.Axis, p = a.createElement, m = a.css, g = a.defined, v = a.each, z = a.erase, u = a.extend,
      y = a.fireEvent, l = a.inArray, b = a.isNumber, e = a.isObject, t = a.isArray, n = a.merge, f = a.objectEach,
      c = a.pick, h = a.Point, w = a.Series, D = a.seriesTypes, r = a.setAnimation, J = a.splat;
    u(a.Chart.prototype, {
      addSeries: function (a, b, f) {
        var e, d = this;
        a && (b = c(b, !0), y(d, "addSeries", {options: a}, function () {
          e = d.initSeries(a);
          d.isDirtyLegend = !0;
          d.linkSeries();
          y(d, "afterAddSeries");
      ...
      addAxis: function (a, b, f, e) {
        ...
        a = n(a, {index: this[d].length, isX: b});
        b = new G(this, a);
        h[d] = J(h[d] || {});
        h[d].push(a);
        c(f, !0) && this.redraw(e);
      ...
      showLoading: function (a) {
        ...
        f || (b.loadingDiv = f = p("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = p("span", {className: "highcharts-loading-inner"}, null, f), B(b,
          "redraw", e));
        f.className = "highcharts-loading";
        b.loadingSpan.innerHTML = a || c.lang.loading;
        m(f, u(d.style, {zIndex: 10}));
        m(b.loadingSpan, d.labelStyle);
        b.loadingShown || (m(f, {
          opacity: 0,
          display: ""
        }), C(f, {opacity: d.style.opacity || .5}, {duration: d.showDuration || 0}));
        b.loadingShown = !0;
        e()
      },
      ...
      update: function (a, e, h, r) {
        ...
        if (x) {
          ...
          "alignTicks" in x && (k = !0);
          f(x, function (a, b) {
            -1 !== l("chart." + b, d.propsRequireUpdateSeries) && (t = !0);
            -1 !== l(b, d.propsRequireDirtyBox) && (d.isDirtyBox = !0)
          });
        ...
        f(a, function (a, b) {
          if (d[b] && "function" === typeof d[b].update) d[b].update(a, !1); else if ("function" === typeof d[q[b]]) d[q[b]](a);
        ...
        v("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
          a[b] && (v(J(a[b]), function (a, c) {
            ...
            if (!c && h) if ("series" === b) d.addSeries(a, !1).touched = !0; else if ("xAxis" === b || "yAxis" === b) d.addAxis(a,
              "xAxis" === b, !1).touched = !0
          }), h && v(d[b], function (a) {
    ...
    u(h.prototype, {
      update: function (a, b, f, h) {
        ...
        var q = this, l = q.series, k = q.graphic,
          g, r = l.chart, n = l.options;
        b = c(b, !0);
        !1 === h ? d() : q.firePointEvent("update", {options: a}, d)
      }, remove: function (a, b) {
    ...
    u(w.prototype, {
      addPoint: function (a, b, f, e) {
        var d = this.options, h = this.data, q = this.chart, k = this.xAxis, k = k && k.hasNames && k.names, l = d.data,
          g, r, n = this.xData, x, t;
        b = c(b, !0);
        g = {series: this};
        this.pointClass.prototype.applyOptions.apply(g, [a]);
        t = g.x;
        x = n.length;
        if (this.requireSorting && t < n[x - 1]) for (r = !0; x && n[x - 1] > t;) x--;
        ...
        var e = this, d = e.data, h = d[a], q = e.points, k = e.chart, l = function () {
        ...
        var e = this, h = e.chart, d = e.userOptions, q = e.oldType || e.type,
          g = b.type || d.type || h.options.chart.type, k = D[q].prototype, r,
          t = ["group", "markerGroup", "dataLabelsGroup"], w = ["navigatorSeries",
            "baseSeries"], m = e.finishedAnimating && {animation: !1}, F = ["data", "name", "turboThreshold"],
          J = a.keys(b), p = 0 < J.length;
        v(J, function (a) {
          -1 === l(a, F) && (p = !1)
        });
        if (p) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1); else {
          w = t.concat(w);
          v(w, function (a) {
            w[a] = e[a];
            delete e[a]
          });
          b = n(d, m, {index: e.index, pointStart: c(d.pointStart, e.xData[0])}, {data: e.options.data}, b);
          e.remove(!1, null, !1);
  ...
  (function (a) {
    var B = a.color, C = a.each, G = a.map, p = a.pick, m = a.Series,
      g = a.seriesType;
    g("area", "line", {softThreshold: !1, threshold: 0}, {
      singleStacks: !1, getStackPoints: function (g) {
        var m = [], u = [], v = this.xAxis, l = this.yAxis, b = l.stacks[this.stackKey], e = {}, t = this.index,
          n = l.series, f = n.length, c, h = p(l.options.reversedStacks, !0) ? 1 : -1, w;
        g = g || this.points;
          ...
          C(u,
            function (a, g) {
              ...
              if (e[a] && !e[a].isNull) m.push(e[a]), C([-1, 1], function (l) {
                var r = 1 === l ? "rightNull" : "leftNull", d = 0, x = b[u[g + l]];
                if (x) for (w = t; 0 <= w && w < f;) q = x.points[w], q || (w === t ? e[a][r] = !0 : c[w] && (n = b[a].points[w]) && (d -= n[1] - n[0])), w += h;
                ...
                m.push({isNull: !0, plotX: v.translate(a, 0, 0, 0, 1), x: a, plotY: r, yBottom: r})
              }
            })
        }
        return m
        ...
        var g = m.prototype.getGraphPath,
          u = this.options, v = u.stacking, l = this.yAxis, b, e, t = [], n = [], f = this.index, c,
          h = l.stacks[this.stackKey], w = u.threshold, D = l.getThreshold(u.threshold), r,
          u = u.connectNulls || "percent" === v, J = function (b, e, g) {
            var q = a[b];
            b = v && h[q.x].points[f];
            var d = q[g + "Null"] || 0;
            g = q[g + "Cliff"] || 0;
            ...
            void 0 !== r && (n.push({
              ...
              isNull: q,
              isCliff: !0
            }), t.push({plotX: c, plotY: null === x ? D : l.getThreshold(x), doCurve: !1}))
          };
        a =
          a || this.points;
        v && (a = this.getStackPoints(a));
        for (b = 0; b < a.length; b++) if (e = a[b].isNull, c = p(a[b].rectPlotX, a[b].plotX), r = p(a[b].yBottom, D), !e || u) u || J(b, b - 1, "left"), e && !v && u || (n.push(a[b]), t.push({
          x: b,
          plotX: c,
          plotY: r
        })), u || J(b, b + 1, "right");
        ...
        var a = this, g = this.areaPath, u = this.options,
          y = [["area", "highcharts-area", this.color, u.fillColor]];
        ...
        C(y, function (l) {
          var b = l[0], e = a[b];
          e ? (e.endX = a.preventGraphAnimation ? null : g.xMap, e.animate({d: g})) : (e = a[b] = a.chart.renderer.path(g).addClass(l[1]).attr({
  ...
  (function (a) {
    ...
    a("spline", "line", {}, {
      getPointSpline: function (a, G, p) {
        var m = G.plotX, g = G.plotY, v = a[p - 1];
        p = a[p + 1];
        var z, u, y, l;
  ...
  (function (a) {
    var B = a.seriesTypes.area.prototype, C = a.seriesType;
  ...
  (function (a) {
    var B = a.animObject, C = a.color, G = a.each, p = a.extend, m = a.isNumber,
      g = a.merge, v = a.pick, z = a.Series, u = a.seriesType, y = a.svg;
    u("column", "line", {
      borderRadius: 0,
      crisp: !0,
      groupPadding: .2,
      ...
      negStacks: !0, init: function () {
        ...
        var a = this, b = a.options, e = a.xAxis, g = a.yAxis, n = e.reversed, f, c = {}, h = 0;
        !1 === b.grouping ? h = 1 : G(a.chart.series, function (b) {
          var e = b.options, l = b.yAxis, r;
        ...
        var w = Math.min(Math.abs(e.transA) * (e.ordinalSlope || b.pointRange || e.closestPointRange || e.tickInterval || 1), e.len),
          m = w * b.groupPadding, r = (w - 2 * m) / (h || 1),
        ...
        var l = this.chart, f = this.borderWidth, c = -(f % 2 ? .5 : 0), f = f % 2 ? .5 : 1;
        ...
        g -= b;
        c && g && (--b, g += 1);
        return {x: a, y: b, width: e, height: g}
      }, translate: function () {
        var a = this, b = a.chart, e = a.options, g = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
          g = a.borderWidth = v(e.borderWidth, g ? 0 : 1), n = a.yAxis, f = e.threshold,
          c = a.translatedThreshold = n.getThreshold(f), h = v(e.minPointLength, 5), w = a.getColumnMetrics(),
          m = w.width, r = a.barW = Math.max(m, 1 + 2 * g), J = a.pointXOffset = w.offset;
        b.inverted && (c -= .5);
        e.pointPadding &&
        (r = Math.ceil(r));
        z.prototype.translate.apply(a);
        G(a.points, function (e) {
          var g = v(e.yBottom, c), q = 999 + Math.abs(g), q = Math.min(Math.max(-q, e.plotY), n.len + q),
            l = e.plotX + J, d = r, t = Math.min(q, g), w, k = Math.max(q, g) - t;
        ...
        var e = this.options, l, n = this.pointAttrToOptions || {};
        l = n.stroke || "borderColor";
        var f = n["stroke-width"] || "borderWidth", c = a && a.color || this.color,
          h = a && a[l] || e[l] || this.color || c, w = a && a[f] || e[f] || this[f] || 0, n = e.dashStyle;
        ...
        l = {fill: c, stroke: h, "stroke-width": w};
        n && (l.dashstyle = n);
        return l
      }, drawPoints: function () {
        var a = this, b = this.chart, e = a.options, t = b.renderer, n = e.animationLimit || 250, f;
        G(a.points, function (c) {
          var h = c.graphic, l = h && b.pointCount < n ? "animate" : "attr";
          if (m(c.plotY) && null !== c.y) {
            f = c.shapeArgs;
            if (h) h[l](g(f)); else c.graphic =
              h = t[c.shapeType](f).add(c.group || a.group);
            e.borderRadius && h.attr({r: e.borderRadius});
        ...
        var b = this, e = this.yAxis, g = b.options, l = this.chart.inverted, f = {},
          c = l ? "translateX" : "translateY", h;
        y && (a ? (f.scaleY = .001, a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(g.threshold))), l ? f.translateX = a - e.len : f.translateY = a, b.group.attr(f)) :
          (h = b.group.attr(c), b.group.animate({scaleY: 1}, p(B(b.options.animation), {
            step: function (a, g) {
              f[c] = h + g.pos * (e.pos - h);
              b.group.attr(f)
            }
  ...
  (function (a) {
    var B = a.deg2rad, C = a.isNumber, G = a.pick, p = a.relativeLength;
    a.CenteredSeriesMixin = {
      getCenter: function () {
        var a = this.options, g = this.chart, v = 2 * (a.slicedOffset || 0), z = g.plotWidth - 2 * v,
          g = g.plotHeight - 2 * v, u = a.center,
          u = [G(u[0], "50%"), G(u[1], "50%"), a.size || "100%", a.innerSize || 0], y = Math.min(z, g), l, b;
        ...
        return {start: B * (a + -90), end: B * (g + -90)}
      }
    }
  })(L);
  (function (a) {
    var B = a.addEvent, C = a.CenteredSeriesMixin, G = a.defined, p = a.each, m = a.extend, g = C.getStartAndEndRadians,
      v = a.inArray, z = a.noop, u = a.pick, y = a.Point,
      l = a.Series, b = a.seriesType, e = a.setAnimation;
    b("pie", "line", {
      center: [null, null],
      clip: !1,
      colorByPoint: !0,
      ...
      animate: function (a) {
        var b = this, f = b.points, c = b.startAngleRad;
        a || (p(f, function (a) {
          var f = a.graphic, e = a.shapeArgs;
          f && (f.attr({r: a.startR || b.center[3] / 2, start: c, end: c}), f.animate({
            r: e.r,
            start: e.start,
            end: e.end
          }, b.options.animation))
      ...
      updateTotals: function () {
        var a, b = 0, f = this.points, c = f.length, e, g = this.options.ignoreHiddenPoint;
      ...
      translate: function (a) {
        this.generatePoints();
        var b = 0, f = this.options, c = f.slicedOffset, e = c + (f.borderWidth || 0), l, m, r,
          t = g(f.startAngle, f.endAngle), q = this.startAngleRad = t.start, t = (this.endAngleRad = t.end) - q,
          F = this.points, x, p = f.dataLabels.distance, f = f.ignoreHiddenPoint, d, H = F.length, E;
        ...
        for (d = 0; d < H; d++) {
          ...
          E.slicedTranslation = {translateX: Math.round(Math.cos(r) * c), translateY: Math.round(Math.sin(r) * c)};
          m = Math.cos(r) * a[2] / 2;
          x = Math.sin(r) * a[2] / 2;
      ...
      drawPoints: function () {
        ...
        p(a.points, function (h) {
          ...
          if (h.isNull) c && (h.graphic = c.destroy()); else {
            ...
            c ? c.setRadialReference(a.center).attr(e).animate(m(g, f)) : (h.graphic = c = b[h.shapeType](g).setRadialReference(a.center).attr(f).add(a.group), h.visible || c.attr({visibility: "hidden"}),
              c.attr(e).attr({"stroke-linejoin": "round"}).shadow(l, r));
      ...
      init: function () {
        ...
        var f = this, c = f.series, e = c.chart, g = c.options.ignoreHiddenPoint;
        b = u(b, g);
  ...
  (function (a) {
    var B =
        a.addEvent, C = a.arrayMax, G = a.defined, p = a.each, m = a.extend, g = a.format, v = a.map, z = a.merge,
      u = a.noop, y = a.pick, l = a.relativeLength, b = a.Series, e = a.seriesTypes, t = a.some, n = a.stableSort;
    ...
    b.prototype.drawDataLabels = function () {
      ...
      var c = this, e = c.chart, l = c.options, n = l.dataLabels, r = c.points, m, q, t =
        c.hasRendered || 0, x, u, d = y(n.defer, !!l.animation), H = e.renderer;
      if (n.enabled || c._hasPointLabels) c.dlProcessOptions && c.dlProcessOptions(n), u = c.plotGroup("dataLabelsGroup", "data-labels", d && !t ? "hidden" : "visible", n.zIndex || 6), d && (u.attr({opacity: +t}), t || B(c, "afterAnimate", function () {
        c.visible && u.show(!0);
        u[l.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
      })), q = n, p(r, function (d) {
        var f, h = d.dataLabel, r, w, t = d.connector, F = !h, E;
        ...
        f && (n = z(q, m), r = d.getLabelConfig(), E = n[d.formatPrefix + "Format"] || n.format, x = G(E) ? g(E, r, e.time) : (n[d.formatPrefix + "Formatter"] || n.formatter).call(r, n), E = n.style, r = n.rotation, E.color = y(n.color, E.color, c.color, "#000000"), "contrast" === E.color && (d.contrastColor = H.getContrast(d.color || c.color), E.color = n.inside || 0 > y(d.labelDistance, n.distance) || l.stacking ? d.contrastColor : "#000000"), l.cursor && (E.cursor = l.cursor), w = {
          fill: n.backgroundColor, stroke: n.borderColor, "stroke-width": n.borderWidth,
          r: n.borderRadius || 0, rotation: r, padding: n.padding, zIndex: 1
    ...
    b.prototype.alignDataLabel = function (a, b, e, g, l) {
      var c = this.chart, f = c.inverted, h = y(a.dlBox && a.dlBox.centerX, a.plotX, -9999), n = y(a.plotY, -9999),
        x = b.getBBox(), w, d = e.rotation, t = e.align,
      ...
      if (E && (w = e.style.fontSize, w = c.renderer.fontMetrics(w, b).b, g = m({
        x: f ? this.yAxis.len - n : h, y: Math.round(f ?
          this.xAxis.len - h : n), width: 0, height: 0
      }, g), m(e, {
        width: x.width,
        height: x.height
      }), d ? (k = !1, h = c.renderer.rotCorr(w, d), h = {
        x: g.x + e.x + g.width / 2 + h.x,
        y: g.y + e.y + {top: 0, middle: .5, bottom: 1}[e.verticalAlign] * g.height
      }, b[l ? "attr" : "animate"](h).attr({align: t}), n = (d + 720) % 360, n = 180 < n && 360 > n, "left" === t ? h.y -= n ? x.height : 0 : "center" === t ? (h.x -= x.width / 2, h.y -= x.height / 2) : "right" === t && (h.x -= x.width, h.y -= n ? 0 : x.height), b.placed = !0, b.alignAttr = h) : (b.align(e, null, g), h = b.alignAttr), k ? a.isLabelJustified = this.justifyDataLabel(b, e,
      ...
      E || (b.attr({y: -9999}), b.placed = !1)
    };
    b.prototype.justifyDataLabel = function (a, b, e, g, l, r) {
      var c = this.chart, f = b.align, h = b.verticalAlign, n, m, d = a.box ? 0 : a.padding || 0;
      n = e.x + d;
    ...
    e.pie && (e.pie.prototype.drawDataLabels = function () {
      var f = this, c = f.data, e, g = f.chart, l = f.options.dataLabels, r = y(l.connectorPadding, 10),
        n = y(l.connectorWidth, 1), q = g.plotWidth, m = g.plotHeight, x = Math.round(g.chartWidth / 3), t,
        d = f.center, H = d[2] / 2, E = d[1], k, A, u, v, z = [[], []], B, N, M, S, O = [0, 0, 0, 0];
      f.visible && (l.enabled ||
        ...
        a.dataLabel && a.visible && (z[a.half].push(a), a.dataLabel._pos = null, !G(l.style.width) && !G(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > x && (a.dataLabel.css({width: .7 * x}), a.dataLabel.shortened = !0))
      }),
        p(z, function (b, c) {
          var h, n, x = b.length, t = [], w;
          if (x) for (f.sortByAngle(b, c - .5), 0 < f.maxLabelDistance && (h = Math.max(0, E - H - f.maxLabelDistance), n = Math.min(E + H + f.maxLabelDistance, g.plotHeight), p(b, function (a) {
        ...
        if ((k = a.dataLabel) && k._pos && a.visible && 0 < a.labelDistance) {
          ...
          if (b = !t) a.connector = t = g.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(f.dataLabelsGroup),
            t.attr({"stroke-width": n, stroke: l.connectorColor || a.color || "#666666"});
          t[b ? "attr" : "animate"]({d: f.connectorPath(a.labelPos)});
          t.attr("visibility", M)
      ...
      var b = this.center, e = this.options, f = e.center, g = e.minSize || 80, r, n = null !== e.size;
    ...
    e.column && (e.column.prototype.alignDataLabel = function (a, c, e, g, l) {
      var f = this.chart.inverted, h = a.series, q = a.dlBox || a.shapeArgs,
        n = y(a.below, a.plotY > y(this.translatedThreshold,
          h.yAxis.len)), m = y(e.inside, !!this.options.stacking);
  ...
  (function (a) {
    var B = a.Chart, C = a.each, G = a.objectEach, p = a.pick;
    a = a.addEvent;
    a(B, "render", function () {
      var a = [];
      ...
      C(this.series || [], function (g) {
        var m = g.options.dataLabels, z = g.dataLabelCollections || ["dataLabel"];
    ...
    B.prototype.hideOverlappingLabels = function (a) {
      var g = a.length, m, p, u, y, l, b, e, t, n, f = function (a, b, e, f, g, l, q, n) {
        return !(g > a + e || g + q < a || l > b + f || l + n < b)
      };
      for (p = 0; p < g; p++) if (m = a[p]) m.oldOpacity = m.opacity, m.newOpacity = 1, m.width || (u = m.getBBox(), m.width = u.width, m.height = u.height);
      a.sort(function (a, b) {
        return (b.labelrank || 0) - (a.labelrank || 0)
      });
      for (p = 0; p < g; p++) for (u = a[p], m = p + 1; m < g; ++m) if (y = a[m], u && y &&
  ...
  (function (a) {
    var B = a.addEvent, C = a.Chart, G = a.createElement, p = a.css, m = a.defaultOptions, g = a.defaultPlotOptions,
      v = a.each, z = a.extend, u = a.fireEvent, y = a.hasTouch, l = a.inArray, b = a.isObject, e = a.Legend,
      t = a.merge, n = a.pick, f = a.Point, c = a.Series, h = a.seriesTypes, w = a.svg, D;
    D = a.TrackerMixin = {
      drawTrackerPoint: function () {
        ...
        a._hasTracking || (v(a.trackerGroups, function (e) {
          if (a[e]) {
            ...
            a.options.cursor && a[e].css(p).css({cursor: a.options.cursor})
          }
        }), a._hasTracking = !0);
        u(this, "afterDrawTracker")
      }, drawTrackerGraph: function () {
        var a = this, b = a.options, c = b.trackByArea, e = [].concat(c ? a.areaPath : a.graphPath), f = e.length,
          h = a.chart, d =
            h.pointer, g = h.renderer, l = h.options.tooltip.snap, k = a.tracker, n, m = function () {
            if (h.hoverSeries !== a) a.onMouseOver()
          }, t = "rgba(192,192,192," + (w ? .0001 : .002) + ")";
        if (f && !c) for (n = f + 1; n--;) "M" === e[n] && e.splice(n + 1, 0, e[n + 1] - l, e[n + 2], "L"), (n && "M" === e[n] || n === f) && e.splice(n, 0, "L", e[n - 2] + l, e[n - 1]);
        k ? k.attr({d: e}) : a.graph && (a.tracker = g.path(e).attr({
          "stroke-linejoin": "round",
    ...
    z(e.prototype, {
      setItemEvents: function (a, b, c) {
        var e = this, h = e.chart.renderer.boxWrapper, g = "highcharts-legend-" +
    ...
    z(C.prototype, {
      showResetZoom: function () {
        ...
        var b = this, c = m.lang, e = b.options.chart.resetZoomButton, f = e.theme, h = f.states,
        ...
        v("xy" === b ? [1, 0] : [1], function (b) {
          b = c[b ? "xAxis" : "yAxis"][0];
          var d = b.horiz, e = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", h = c[d],
            k = (b.pointRange || 0) / 2, g = b.reversed && !c.inverted || !b.reversed && c.inverted ? -1 : 1,
            l = b.getExtremes(),
            n = b.toValue(h - e, !0) + k * g, g = b.toValue(h + b.len - e, !0) - k * g, q = g < n, h = q ? g : n,
            n = q ? n : g, g = Math.min(l.dataMin, k ? l.min : b.toValue(b.toPixels(l.min) - b.minPixelPadding)),
            k = Math.max(l.dataMax, k ? l.max : b.toValue(b.toPixels(l.max) + b.minPixelPadding)), q = g - h;
          0 < q && (n += q, h = g);
          q = n - k;
          0 < q && (n = k, h -= q);
          b.series.length && h !== l.min && n !== l.max && (b.setExtremes(h, n, !1, !1, {trigger: "pan"}), f = !0);
          c[d] = e
        });
        f && c.redraw(!1);
    ...
    z(f.prototype, {
      select: function (a, b) {
        ...
        if (!this.hasImportedEvents) {
          var b = this, c = t(b.series.options.point, b.options).events;
          b.events = c;
        ...
        var c = Math.floor(this.plotX), e = this.plotY, f = this.series, h = f.options.states[a || "normal"] || {},
          d = g[f.type].marker && f.options.marker, l = d && !1 === d.enabled, r = d && d.states &&
          d.states[a || "normal"] || {}, k = !1 === r.enabled, m = f.stateMarkerGraphic, t = this.marker || {},
          w = f.chart, p = f.halo, D, v = d && f.markerAttribs;
        a = a || "";
        if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (k || l && !1 === r.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
          ...
          if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(f.pointAttribs(this, a), n(w.options.chart.animation,
            h.animation)), D && this.graphic.animate(D, n(w.options.chart.animation, r.animation, d.animation)), m && m.hide(); else {
            if (a && r) {
              d = t.symbol || f.symbol;
          ...
          (c = h.halo) && c.size ? (p || (f.halo = p = w.renderer.path().add((this.graphic ||
            m).parentGroup)), p.show()[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), p.attr({"class": "highcharts-halo highcharts-color-" + n(this.colorIndex, f.colorIndex) + (this.className ? " " + this.className : "")}), p.point = this, p.attr(z({
            fill: this.color || f.color,
            "fill-opacity": c.opacity,
            zIndex: -1
          }, c.attributes))) : p && p.point && p.point.haloPath && p.animate({d: p.point.haloPath(0)}, null, p.hide);
          this.state = a;
    ...
    z(c.prototype, {
      onMouseOver: function () {
        ...
        var b = this,
          c = b.options, e = b.graph, f = c.states, h = c.lineWidth, c = 0;
        a = a || "";
        ...
        }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (h = f[a].lineWidth || h + (f[a].lineWidthPlus || 0)), e && !e.dashstyle)) for (h = {"stroke-width": h}, e.animate(h, n(f[a || "normal"] && f[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(h), c += 1
      },
      setVisible: function (a, b) {
        var c = this, e = c.chart, f = c.legendItem, h, d = e.options.chart.ignoreHiddenSeries, g = c.visible;
  ...
  (function (a) {
    var B = a.Chart, C = a.each, G = a.inArray, p = a.isArray, m = a.isObject, g = a.pick, v = a.splat;
    B.prototype.setResponsive = function (g) {
      var m = this.options.responsive, p = [], l = this.currentResponsive;
    ...
    B.prototype.currentOptions = function (g) {
      function u(g, b, e, t) {
        ...
        a.objectEach(g, function (a, c) {
          if (!t && -1 < G(c, ["series", "xAxis", "yAxis"])) for (a = v(a), e[c] = [], l = 0; l < a.length; l++) b[c][l] && (e[c][l] = {}, u(a[l], b[c][l], e[c][l], t + 1)); else m(a) ? (e[c] = p(a) ? [] : {}, u(a, b[c] || {}, e[c], t + 1)) :
            e[c] = b[c] || null
        })
      }
  ...
  (function (a) {
    var B = a.addEvent, C = a.Axis, G = a.Chart, p = a.css, m = a.defined, g = a.each, v = a.extend, z = a.noop,
      u = a.pick, y = a.timeUnits, l = a.wrap;
    ...
    l(C.prototype, "getTimeTicks", function (a, e, g, l, f, c, h, w) {
      var b = 0, n, t, q = {}, p, x, u, d = [], H = -Number.MAX_VALUE, E = this.options.tickPixelInterval,
        k = this.chart.time;
    ...
    v(C.prototype, {
      beforeSetTickPositions: function () {
        var a, e = [], l = !1, n, f = this.getExtremes(), c = f.min, h = f.max, w,
          p = this.isXAxis && !!this.options.breaks, f = this.options.ordinal, r = Number.MAX_VALUE,
        ...
        if (f || p) {
          g(this.series, function (b, c) {
            if (!(v && !1 === b.visible || !1 === b.takeOrdinalPosition && !p) && (e = e.concat(b.processedXData), a = e.length, e.sort(function (a, b) {
              return a -
                b
            }), r = Math.min(r, u(b.closestPointRange, r)), a)) for (c = a - 1; c--;) e[c] === e[c + 1] && e.splice(c, 1)
          });
          a = e.length;
          if (2 < a) {
            n = e[1] - e[0];
        ...
        var b = this.ordinalPositions;
        if (b) {
          var g = this.ordinalSlope, f = this.ordinalOffset, c = b.length - 1, h;
          if (e) 0 > a ? a = b[0] : a > c ? a = b[c] : (c = Math.floor(a), h = a - c); else for (; c--;) if (e = g * c + f, a >= e) {
            g = g * (c + 1) + f;
            h = (a - e) / (g - e);
            break
          }
        ...
        var a = this, e = a.chart, l = a.series[0].currentDataGrouping, n = a.ordinalIndex,
          f = l ? l.count + l.unitName :
            "raw", c = a.options.overscroll, h = a.getExtremes(), m, p;
        n || (n = a.ordinalIndex = {});
        n[f] || (m = {
          series: [], chart: e, getExtremes: function () {
            return {min: h.dataMin, max: h.dataMax + c}
          }, options: {ordinal: !0}, val2lin: C.prototype.val2lin, ordinal2lin: C.prototype.ordinal2lin
        }, g(a.series, function (b) {
          p = {xAxis: m, xData: b.xData.slice(), chart: e, destroyGroupedData: z};
        ...
        var b = this.options.overscroll, e = this.overscrollPointsRange, g = [], l = this.dataMax;
        if (a.defined(e)) for (g.push(l); l <= this.dataMax + b;) l += e, g.push(l);
        return g
    ...
    l(G.prototype, "pan", function (a, e) {
      var b = this.xAxis[0], l = b.options.overscroll, f = e.chartX, c = !1;
      if (b.options.ordinal && b.series.length) {
        var h = this.mouseDownX, m = b.getExtremes(), u = m.dataMax, r = m.min, v = m.max, q = this.hoverPoints,
          F = b.closestPointRange || b.overscrollPointsRange,
          h = (h - f) / (b.translationSlope * (b.ordinalSlope || F)), x = {ordinalPositions: b.getExtendedPositions()},
          F = b.lin2val, y = b.val2lin, d;
        ...
        h.max <= Math.max(u, v) + l && b.setExtremes(h.min, h.max, !0, !1, {trigger: "pan"}), this.mouseDownX = f, p(this.container, {cursor: "move"})) : c = !0
      } else c = !0;
  ...
  (function (a) {
    ...
    var G = a.addEvent, p = a.pick, m = a.wrap, g = a.each, v = a.extend, z = a.isArray, u = a.fireEvent,
      y = a.Axis, l = a.Series;
    v(y.prototype, {
      isInBreak: function (a, e) {
        var b = a.repeat || Infinity, g = a.from, f = a.to - a.from;
        e = e >= g ? (e - g) % b : b - (g - e) % b;
        return a.inclusive ? e <= f : e < f && 0 !== e
      }, isInAnyBreak: function (a, e) {
        var b = this.options.breaks, g = b && b.length, f, c, h;
        if (g) {
    ...
    G(y, "afterSetTickPositions", function () {
      if (this.options.breaks) {
        var a = this.tickPositions, e = this.tickPositions.info, g = [], l;
    ...
    G(y, "afterInit", function () {
      ...
      a.isBroken && (a.val2lin = function (b) {
        var e = b, f, c;
        for (c = 0; c < a.breakArray.length; c++) if (f = a.breakArray[c], f.to <= b) e -= f.len; else if (f.from >= b) break; else if (a.isInBreak(f, b)) {
          e -= b - f.from;
          break
        }
        return e
        ...
        b = a.options.breaks;
        var e = [], f = [], c = 0, h, l, m = a.userMin || a.min, r = a.userMax || a.max, t = p(a.pointRangePadding, 0),
          q, v;
        g(b, function (b) {
          l = b.repeat || Infinity;
          a.isInBreak(b,
        ...
        g(b, function (a) {
          ...
          for (; q < m;) q += l;
          for (v = q; v < r; v += l) e.push({value: v, move: "in"}), e.push({
            value: v + (a.to - a.from),
            move: "out",
            size: a.breakSize
          })
        ...
        g(e, function (a) {
          ...
          0 === h && (f.push({from: q, to: a.value, len: a.value - q - (a.size || 0)}), c += a.value - q -
            (a.size || 0))
        });
        a.breakArray = f;
    ...
    m(l.prototype, "generatePoints", function (a) {
      ...
      var b = this.xAxis, g = this.yAxis, l = this.points, f, c = l.length, h = this.options.connectNulls, m;
      if (b && g && (b.options.breaks || g.options.breaks)) for (; c--;) f = l[c], m = null === f.y && !1 === h, m || !b.isInAnyBreak(f.x,
        !0) && !g.isInAnyBreak(f.y, !0) || (l.splice(c, 1), this.data[c] && this.data[c].destroyElements())
    });
    a.Series.prototype.drawBreaks = function (a, e) {
      var b = this, l = b.points, f, c, h, m;
      a && g(e, function (e) {
        f = a.breakArray || [];
        ...
        g(l, function (b) {
          ...
          g(f, function (e) {
            h = !1;
            if (c < e.from && m > e.to || c > e.from && m < e.from) h = "pointBreak"; else if (c < e.from && m > e.from && m < e.to || c > e.from && m > e.to && m < e.from) h = "pointInBreak";
            h && u(a, h, {point: b, brk: e})
          })
        })
      })
    };
    a.Series.prototype.gappedPath =
      function () {
        var b = this.currentDataGrouping, e = b && b.totalRange, b = this.options.gapSize, g = this.points.slice(),
          l = g.length - 1, f = this.yAxis;
        if (b && 0 < l) for ("value" !== this.options.gapUnit && (b *= this.closestPointRange), e && e > b && (b = e); l--;) g[l + 1].x - g[l].x > b && (e = (g[l].x + g[l + 1].x) / 2, g.splice(l + 1, 0, {
          isNull: !0,
          x: e
  ...
  (function (a) {
    var B = a.addEvent, C = a.arrayMax, G = a.arrayMin, p = a.Axis, m = a.defaultPlotOptions, g = a.defined, v = a.each,
      z = a.extend, u = a.format, y = a.isNumber, l = a.merge, b = a.pick, e = a.Point, t = a.Series, n = a.Tooltip,
      f = a.wrap, c = t.prototype, h = c.processData, w = c.generatePoints, D = {
      ...
      J = a.defaultDataGroupingUnits = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]],
      q = a.approximations = {
        sum: function (a) {
          var b = a.length, c;
    ...
    c.groupData = function (a, b, c, d) {
      var e = this.data, f = this.options.data, k = [], h = [], g = [], l = a.length, m, n, p = !!b, w = [];
      d = "function" === typeof d ? d : q[d] || r[this.type] && q[r[this.type].approximation] || q[D.approximation];
      var x = this.pointArrayMap, t = x && x.length, u = 0;
      n = 0;
      var F, z;
      t ? v(x, function () {
        w.push([])
      ...
      for (z; z <= l; z++) {
        for (; void 0 !== c[u + 1] && a[z] >= c[u + 1] || z === l;) {
          m = c[u];
          this.dataGroupInfo = {start: n, length: w[0].length};
          n = d.apply(this, w);
        ...
        if (x) {
          m = this.cropStart + z;
          var J = e && e[m] || this.pointClass.prototype.applyOptions.apply({series: this}, [f[m]]), B;
    ...
    c.processData = function () {
      var a = this.chart, e = this.options.dataGrouping, f = !1 !==
        this.allowDG && e && b(e.enabled, a.options.isStock), d = this.visible || !a.options.chart.ignoreHiddenSeries,
        l, m = this.currentDataGrouping, k;
      this.forceCrop = f;
      this.groupPixelWidth = null;
      this.hasProcessed = !0;
      if (!1 !== h.apply(this, arguments) && f) {
        this.destroyGroupedData();
        var n, q = e.groupAll ? this.xData : this.processedXData, r = e.groupAll ? this.yData : this.processedYData,
          p = a.plotSizeX, a = this.xAxis, w = a.options.ordinal,
    ...
    f(n.prototype, "tooltipFooterHeaderFormatter", function (a, b, c) {
      var d = this.chart.time, e = b.series, f = e.tooltipOptions, k = e.options.dataGrouping, h = f.xDateFormat, g,
        l = e.xAxis;
    ...
    B(t, "afterSetOptions", function (a) {
      a = a.options;
      var b = this.type, c = this.chart.options.plotOptions, d = m[b].dataGrouping, e = this.useCommonDataGrouping && D;
    ...
    p.prototype.setDataGrouping = function (a, c) {
      ...
      if (this instanceof p) for (e = this.series.length; e--;) this.series[e].update({dataGrouping: a}, !1); else v(this.chart.options.series, function (b) {
        b.dataGrouping = a
      }, !1);
  ...
  (function (a) {
    var B = a.each, C = a.Point, G = a.seriesType, p = a.seriesTypes;
    G("ohlc", "column", {
      lineWidth: 1,
      ...
      drawPoints: function () {
        ...
        B(a.points, function (m) {
          var p, u, v, l, b = m.graphic, e, t = !b;
          void 0 !== m.plotY && (b || (m.graphic = b = g.renderer.path().add(a.group)), b.attr(a.pointAttribs(m, m.selected && "select")), u = b.strokeWidth() %
            2 / 2, e = Math.round(m.plotX) - u, v = Math.round(m.shapeArgs.width / 2), l = ["M", e, Math.round(m.yBottom), "L", e, Math.round(m.plotHigh)], null !== m.open && (p = Math.round(m.plotOpen) + u, l.push("M", e, p, "L", e - v, p)), null !== m.close && (p = Math.round(m.plotClose) + u, l.push("M", e, p, "L", e + v, p)), b[t ? "attr" : "animate"]({d: l}).addClass(m.getClassName(), !0))
        })
      },
      animate: null
    }, {
  ...
  (function (a) {
    var B =
      a.defaultPlotOptions, C = a.each, G = a.merge, p = a.seriesType, m = a.seriesTypes;
    p("candlestick", "ohlc", G(B.column, {
      ...
      pointAttribs: function (a, p) {
        var g = m.column.prototype.pointAttribs.call(this, a, p), u = this.options, v = a.open < a.close,
        ...
        C(a.points, function (g) {
          var p = g.graphic, v, l, b, e, t, n, f, c = !p;
          void 0 !== g.plotY && (p || (g.graphic = p = m.renderer.path().add(a.group)), p.attr(a.pointAttribs(g, g.selected && "select")).shadow(a.options.shadow), t = p.strokeWidth() % 2 / 2, n = Math.round(g.plotX) - t, v = g.plotOpen, l = g.plotClose, b = Math.min(v, l), v = Math.max(v, l), f = Math.round(g.shapeArgs.width /
            2), l = Math.round(b) !== Math.round(g.plotHigh), e = v !== g.yBottom, b = Math.round(b) + t, v = Math.round(v) + t, t = [], t.push("M", n - f, v, "L", n - f, b, "L", n + f, b, "L", n + f, v, "Z", "M", n, b, "L", n, l ? Math.round(g.plotHigh) : b, "M", n, v, "L", n, e ? Math.round(g.yBottom) : v), p[c ? "attr" : "animate"]({d: t}).addClass(g.getClassName(), !0))
        })
      }
    })
  })(L);
  da = function (a) {
    var B = a.each, C = a.defined, G = a.seriesTypes, p = a.stableSort;
    return {
      getPlotBox: function () {
        ...
        var a = this.options, g = this.chart, v = this.points, z = v.length - 1, u, y, l = a.onSeries,
          l = l && g.get(l), a = a.onKey || "y", b = l && l.options.step, e = l && l.points, t = e && e.length,
          n = g.inverted, f = this.xAxis, c = this.yAxis, h = 0, w, D, r, J;
        if (l && l.visible && t) for (h = (l.pointXOffset || 0) + (l.barW || 0) / 2, u = l.currentDataGrouping, D = e[t - 1].x + (u ? u.totalRange : 0), p(v, function (a, b) {
          return a.x - b.x
  ...
  (function (a, B) {
    ...
    var G = a.addEvent, p = a.each, m = a.merge, g = a.noop, v = a.Renderer, z = a.seriesType, u = a.TrackerMixin,
      y = a.VMLRenderer, l = a.SVGRenderer.prototype.symbols;
    z("flags", "column", {
      pointRange: 0,
      allowOverlapX: !1,
      shape: "flag",
      ...
      pointAttribs: function (a, e) {
        var b = this.options, g = a && a.color || this.color, f = b.lineColor, c = a && a.lineWidth;
        a = a && a.fillColor ||
          b.fillColor;
        e && (a = b.states[e].fillColor, f = b.states[e].lineColor, c = b.states[e].lineWidth);
        return {fill: a || g, stroke: f || g, "stroke-width": c || b.lineWidth || 0}
      },
      translate: B.translate,
      getPlotBox: B.getPlotBox,
      drawPoints: function () {
        var b = this.points, e = this.chart, g = e.renderer, l, f, c = e.inverted, h = this.options, w = h.y, u, r, v,
          q, y, x, z = this.yAxis, d = {}, H = [];
        for (r = b.length; r--;) v = b[r], x = (c ? v.plotY : v.plotX) > this.xAxis.len, l = v.plotX, q = v.stackIndex, u = v.options.shape || h.shape, f = v.plotY, void 0 !== f && (f = v.plotY + w - (void 0 !== q &&
          ...
          v.anchorX), q.attr({text: v.options.title || h.title || "A"})[q.isNew ? "attr" : "animate"](u), h.allowOverlapX || (d[v.plotX] ? d[v.plotX].size = Math.max(d[v.plotX].size, q.width) : d[v.plotX] = {
          align: 0,
          size: q.width,
          target: l,
          anchorX: l
        ...
        h.allowOverlapX || (a.objectEach(d, function (a) {
          ...
          b && (a.graphic[a.graphic.isNew ? "attr" : "animate"]({x: b.pos, anchorX: a.anchorX}),
            a.graphic.isNew = !1)
        }));
  ...
  (function (a) {
    ...
    var C = a.addEvent, G = a.Axis, p = a.correctFloat, m = a.defaultOptions, g = a.defined,
      v = a.destroyObjectProperties, z = a.each, u = a.fireEvent, y = a.hasTouch, l = a.isTouchDevice, b =
        a.merge, e = a.pick, t = a.removeEvent, n = a.wrap, f, c = {
        height: l ? 20 : 14,
        barBorderRadius: 0,
    ...
    B.prototype = {
      init: function (a, f, g) {
        ...
        this.scrollbarRifles = a.path(f(["M", -3, c / 4, "L", -3, 2 * c / 3, "M", 0, c / 4, "L", 0, 2 * c / 3, "M",
          3, c / 4, "L", 3, 2 * c / 3], b.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup);
        ...
        var f =
          this.options.vertical, h = 0, g = this.rendered ? "animate" : "attr";
        this.x = a;
        ...
        this.track[g]({width: c, height: e});
        this.scrollbarButtons[1][g]({translateX: f ? 0 : c - b, translateY: f ? e - h : 0})
      },
      drawScrollbarButton: function (a) {
        var b = this.renderer, c = this.scrollbarButtons, e = this.options, h = this.size, g;
        g = b.g().add(this.group);
        c.push(g);
        g = b.rect().addClass("highcharts-scrollbar-button").add(g);
        g.attr({stroke: e.buttonBorderColor, "stroke-width": e.buttonBorderWidth, fill: e.buttonBackgroundColor});
        g.attr(g.crisp({x: -.5, y: -.5, width: h + 1, height: h + 1, r: e.buttonBorderRadius}, g.strokeWidth()));
        g = b.path(f(["M", h / 2 + (a ? -1 : 1), h / 2 - 3, "L", h / 2 + (a ? -1 : 1), h / 2 + 3, "L", h / 2 + (a ? 2 : -2), h / 2], e.vertical)).addClass("highcharts-scrollbar-arrow").add(c[a]);
        g.attr({fill: e.buttonArrowColor})
      }, setRange: function (a, b) {
        var c = this.options, e = c.vertical, f = c.minWidth, h = this.barWidth, l, m,
          n = this.rendered && !this.hasDragged ? "animate" : "attr";
        g(h) && (a = Math.max(a, 0), l = Math.ceil(h * a), this.calculatedWidth = m = p(h * Math.min(b, 1) - l), m < f && (l = (h - f + m) * a, m = f), f = Math.floor(l + this.xOffset + this.yOffset), h = m / 2 - .5, this.from = a, this.to = b, e ? (this.scrollbarGroup[n]({translateY: f}), this.scrollbar[n]({height: m}), this.scrollbarRifles[n]({translateY: h}), this.scrollbarTop = f, this.scrollbarLeft =
          0) : (this.scrollbarGroup[n]({translateX: f}), this.scrollbar[n]({width: m}), this.scrollbarRifles[n]({translateX: h}), this.scrollbarLeft = f, this.scrollbarTop = 0), 12 >= m ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === c.showFull && (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0)
      }, initEvents: function () {
        var a = this;
        ...
        var a = this.options.inverted ? [1, 0] : [0, 1], b = this.scrollbarButtons, c = this.scrollbarGroup.element,
          e = this.mouseDownHandler, f = this.mouseMoveHandler, g = this.mouseUpHandler,
          a = [[b[a[0]].element, "click", this.buttonToMinClick], [b[a[1]].element, "click", this.buttonToMaxClick], [this.track.element, "click", this.trackClick], [c, "mousedown", e], [c.ownerDocument, "mousemove", f], [c.ownerDocument,
            "mouseup", g]];
    ...
    n(G.prototype, "init", function (a) {
      ...
      b.options.scrollbar && b.options.scrollbar.enabled && (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick = !1, b.scrollbar = new B(b.chart.renderer, b.options.scrollbar, b.chart), C(b.scrollbar, "changed", function (a) {
        var c = Math.min(e(b.options.min, b.min), b.min, b.dataMin),
          f = Math.max(e(b.options.max, b.max), b.max, b.dataMax) - c, g;
    ...
    n(G.prototype, "render", function (a) {
      var b = Math.min(e(this.options.min, this.min), this.min, e(this.dataMin, this.min)),
        c = Math.max(e(this.options.max, this.max), this.max, e(this.dataMax, this.max)), f = this.scrollbar,
  ...
  (function (a) {
    ...
    var C = a.addEvent, G = a.Axis, p = a.Chart, m = a.color,
      g = a.defaultOptions, v = a.defined, z = a.destroyObjectProperties, u = a.each, y = a.erase, l = a.error,
      b = a.extend, e = a.grep, t = a.hasTouch, n = a.isArray, f = a.isNumber, c = a.isObject, h = a.merge, w = a.pick,
      D = a.removeEvent, r = a.Scrollbar, J = a.Series, q = a.seriesTypes, F = a.wrap,
      x = [].concat(a.defaultDataGroupingUnits), K = function (a) {
        var b = e(arguments, f);
    ...
    b(g, {
      navigator: {
        ...
        series: {
          ...
          lineWidth: 1,
          compare: null,
          dataGrouping: {approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: x},
    ...
    B.prototype = {
      drawHandle: function (a, b, c, e) {
        ...
        var d = this.navigatorOptions.maskInside,
          f = this.outline.strokeWidth(), k = f / 2, f = f % 2 / 2, g = this.outlineHeight, h = this.scrollbarHeight,
          l = this.size, m = this.left - h, n = this.top;
        ...
        var d = this.left, f = this.top, k = this.height, g, h, l, m;
        c ? (l = [d, d, d], m = [f, f + a,
          f + b], h = [k, k, k], g = [a, b - a, this.size - b]) : (l = [d, d + a, d + b], m = [f, f, f], h = [a, b - a, this.size - b], g = [k, k, k]);
        u(this.shades, function (a, b) {
          a[e]({x: l[b], y: m[b], width: h[b], height: g[b]})
        })
      }, renderElements: function () {
        var a = this, b = a.navigatorOptions, c = b.maskInside, e = a.chart, f = e.inverted, g = e.renderer, h;
        a.navigatorGroup = h = g.g("navigator").attr({zIndex: 8, visibility: "hidden"}).add();
        var l = {cursor: f ? "ns-resize" : "ew-resize"};
        u([!c, c, !c], function (d, c) {
          a.shades[c] = g.rect().addClass("highcharts-navigator-mask" + (1 === c ? "-inside" :
            "-outside")).attr({fill: d ? b.maskFill : "rgba(0,0,0,0)"}).css(1 === c && l).add(h)
        });
        ...
        b.handles.enabled && u([0, 1], function (d) {
          ...
          var c = b.handles;
          a.handles[d].attr({fill: c.backgroundColor, stroke: c.borderColor, "stroke-width": c.lineWidth}).css(l)
        })
      }, update: function (a) {
        ...
        var d = this.chart, g, h, l = this.scrollbarHeight, m, n = this.xAxis;
        g = n.fake ? d.xAxis[0] : n;
        var q = this.navigatorEnabled, p, r = this.rendered;
        h = d.inverted;
        var t, x = d.xAxis[0].minRange, u =
          d.xAxis[0].options.maxRange;
        if (!this.hasDragged || v(e)) {
          if (!f(b) || !f(c)) if (r) e = 0, k = w(n.width, g.width); else return;
          ...
          q && (this.navigatorGroup.attr({visibility: "visible"}), r = r && !this.hasDragged ? "animate" : "attr", this.drawMasks(e, p, h, r), this.drawOutline(e, p, h, r), this.navigatorOptions.handles.enabled && (this.drawHandle(e,
        ...
        var a = this, b = a.chart, c = b.container, e = [], f, g;
        ...
        var d = this.chart, c = this.xAxis, e = this.zoomedMin, f = this.left, g = this.size, h = this.range,
          l = a.chartX, m, n;
        ...
        1 === b ? (this.grabbedCenter = l, this.fixedWidth = h, this.dragOffset = l - e) : (a = l - f - h / 2, 0 === b ? a = Math.max(0, a) : 2 === b && a + h >= g && (a = g - h, c.reversed ? (a -= h, n = this.getUnionExtremes().dataMin) : m = this.getUnionExtremes().dataMax), a !== e && (this.fixedWidth = h, b = c.toFixedRange(a, a + h, n, m), v(b.min) && d.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min,
          b.max), !0, null, {trigger: "navigator"})))
        ...
        var b = this, d = b.chart, c = b.left, e = b.navigatorSize, f = b.range, g = b.dragOffset, h = d.inverted;
        a.touches &&
        ...
        var b = this.chart, d = this.xAxis, c = d && d.reversed, e = this.scrollbar,
          f, g, h = a.DOMEvent || a;
        (!this.hasDragged || e && e.hasDragged) && "scrollbar" !== a.trigger || (e = this.getUnionExtremes(), this.zoomedMin === this.otherHandlePos ? f = this.fixedExtreme : this.zoomedMax === this.otherHandlePos && (g = this.fixedExtreme), this.zoomedMax === this.size && (g = c ? e.dataMin : e.dataMax), 0 === this.zoomedMin && (f = c ? e.dataMax : e.dataMin), d = d.toFixedRange(this.zoomedMin, this.zoomedMax, f, g), v(d.min) && b.xAxis[0].setExtremes(Math.min(d.min, d.max), Math.max(d.min, d.max), !0, this.hasDragged ? !1 : null, {
          trigger: "navigator",
          triggerOp: "navigator-drag", DOMEvent: h
        }));
        ...
        var b = a.options, d = b.navigator, c = d.enabled, e = b.scrollbar, f = e.enabled, b = c ? d.height : 0,
          g = f ? e.height : 0;
        this.handles = [];
        this.shades = [];
        this.chart = a;
        ...
        var l =
            this, e = l.baseSeries, f = a.xAxis.length, m = a.yAxis.length,
          n = e && e[0] && e[0].xAxis || a.xAxis[0] || {options: {}};
        a.extraMargin = {
        ...
        a.isDirtyBox = !0;
        l.navigatorEnabled ? (l.xAxis = new G(a, h({breaks: n.options.breaks, ordinal: n.options.ordinal}, d.xAxis, {
          id: "navigator-x-axis",
          ...
          index: m,
          zoomEnabled: !1
        }, a.inverted ? {width: b} : {height: b})), e || d.series.data ? l.updateNavigatorSeries(!1) : 0 === a.series.length && (l.unbindRedraw = C(a, "beforeRedraw", function () {
          0 < a.series.length && !l.series && (l.setBaseSeries(), l.unbindRedraw())
        })), l.renderElements(), l.addMouseEvents()) : l.xAxis =
          {
            translate: function (b, d) {
              var c = a.xAxis[0], e = c.getExtremes(), f = c.len - 2 * g, k = K("min", c.options.min, e.dataMin),
        ...
        a.options.scrollbar.enabled && (a.scrollbar = l.scrollbar = new r(a.renderer, h(a.options.scrollbar, {
          ...
          var d =
            l.size, c = d * this.to, d = d * this.from;
      ...
      setBaseSeries: function (a, b) {
        ...
        var e = this, f = e.chart, l = e.baseSeries, m, q, p = e.navigatorOptions.series, r, t = {
        ...
        l && l.length && u(l, function (a) {
          var d = a.navigatorSeries, k = b({color: a.color}, n(p) ? g.navigator.series : p);
        ...
        if (p.data && (!l || !l.length) || n(p)) e.hasNavigatorData = !1, p = a.splat(p), u(p, function (a, b) {
          ...
          q = h(g.navigator.series, {color: f.series[b] && !f.series[b].options.isInternal && f.series[b].color || f.options.colors[b] || f.options.colors[0]}, t, a);
          q.data = a.data;
    ...
    F(G.prototype, "zoom", function (a, b, c) {
      var d = this.chart, e = d.options, f = e.chart.zoomType,
        g = e.chart.pinchType, h = e.navigator, e = e.rangeSelector, l;
    ...
    C(p, "afterSetChartSize",
      function () {
        var a = this.legend, b = this.navigator, c, e, f, g;
  ...
  (function (a) {
    ...
    var C = a.addEvent, G = a.Axis, p = a.Chart, m = a.css, g = a.createElement, v = a.defaultOptions, z = a.defined,
      u = a.destroyObjectProperties, y = a.discardElement, l = a.each, b = a.extend, e = a.fireEvent, t = a.isNumber,
      n = a.merge, f = a.pick, c = a.pInt, h = a.splat, w = a.wrap;
    b(v, {
      rangeSelector: {
        verticalAlign: "top",
    ...
    v.lang = n(v.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    B.prototype = {
      clickButton: function (a, b) {
        var c = this, e = c.chart, g = c.buttonOptions[a], m = e.xAxis[0],
          n = e.scroller && e.scroller.getUnionExtremes() || m || {}, d = n.dataMin, p = n.dataMax, r,
          k = m && Math.round(Math.min(m.max, f(p, m.max))), u = g.type, v, n = g._range, w, D, y, z = g.dataGrouping;
        if (null !== d && null !== p) {
          e.fixedRange = n;
          z && (this.forcedDataGrouping =
            !0, G.prototype.setDataGrouping.call(m || {chart: this.chart}, z, !1));
          if ("month" === u || "year" === u) m ? (u = {
            ...
            dataMin: d,
            dataMax: p
          }, r = m.minFromRange.call(u), t(u.newMax) && (k = u.newMax)) : n = g; else if (n) r = Math.max(k - n, d), k = Math.min(r + n, p); else if ("ytd" === u) if (m) void 0 === p && (d = Number.MAX_VALUE, p = Number.MIN_VALUE, l(e.series, function (a) {
            a = a.xData;
            d = Math.min(a[0], d);
            p = Math.max(a[a.length - 1], p)
          }), b = !1), k = c.getYTDExtremes(p, d, e.time.useUTC), r = w = k.min, k = k.max; else {
      ...
      defaultButtons: [{type: "month", count: 1, text: "1m"}, {type: "month", count: 3, text: "3m"}, {
        ...
        {type: "all", text: "All"}],
      init: function (a) {
        var b = this, c = a.options.rangeSelector, f = c.buttons || [].concat(b.defaultButtons), g = c.selected,
          h = function () {
      ...
      updateButtonStates: function () {
        var a = this.chart, b = a.xAxis[0], c = Math.round(b.max - b.min), e = !b.hasVisibleSeries,
          f = a.scroller && a.scroller.getUnionExtremes() || b, g = f.dataMin, h = f.dataMax,
          a = this.getYTDExtremes(h, g, a.time.useUTC), d = a.min, m = a.max, n = this.selected, k = t(n),
          p = this.options.allButtonsEnabled, u = this.buttons;
        l(this.buttonOptions,
          function (a, f) {
            var l = a._range, q = a.type, r = a.count || 1, t = u[f], v = 0;
            a = a._offsetMax - a._offsetMin;
            f = f === n;
            var x = l > h - g, w = l < b.minRange, A = !1, y = !1, l = l === c;
      ...
      computeButtonRange: function (a) {
        var b = a.type, c = a.count || 1, e = {
          ...
          minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5
        };
      ...
      drawInput: function (a) {
        function e() {
          var a = y.value, b = (u.inputDateParser || Date.parse)(a), d = h.xAxis[0],
            e = h.scroller && h.scroller.xAxis ? h.scroller.xAxis : d, g = e.dataMin, e = e.dataMax;
          b !== y.previousValue && (y.previousValue = b, t(b) || (b = a.split("-"), b = Date.UTC(c(b[0]), c(b[1]) - 1, c(b[2]))), t(b) && (h.time.useUTC || (b += 6E4 * (new Date).getTimezoneOffset()), w ? b > f.maxInput.HCTime ? b = void 0 : b < g && (b = g) : b < f.minInput.HCTime ? b = void 0 : b > e && (b = e), void 0 !== b && d.setExtremes(w ? b : d.min, w ? d.max : b, void 0, void 0, {trigger: "rangeSelectorInput"})))
        }

        var f = this, h = f.chart, l = h.renderer.style || {}, p = h.renderer, u = h.options.rangeSelector, d = f.div,
          w = "min" === a, y, k, A = this.inputGroup;
        ...
        p.css(n({color: "#333333"}, l, u.inputStyle));
        m(y, b({
          position: "absolute",
          border: 0,
          width: "1px",
      ...
      render: function (a, b) {
        var c = this, e = c.chart, h = e.renderer, m = e.container, n = e.options,
          d = n.exporting && !1 !== n.exporting.enabled && n.navigation && n.navigation.buttonOptions, p = v.lang,
          r = c.div, k = n.rangeSelector, n = k.floating,
          t = c.buttons, r = c.inputGroup, u = k.buttonTheme, w = k.buttonPosition, y = k.inputPosition,
          z = k.inputEnabled, D = u && u.states, B = e.plotLeft, C, G = c.buttonGroup, L;
        L = c.rendered;
        var X = c.options.verticalAlign, Z = e.legend, aa = Z && Z.options, ba = w.y, Y = y.y, ca = L || !1, W = 0,
          T = 0, U;
        if (!1 !== k.enabled) {
          L || (c.group = L = h.g("range-selector-group").attr({zIndex: 7}).add(), c.buttonGroup = G = h.g("range-selector-buttons").add(L), c.zoomText = h.text(p.rangeSelectorZoom, f(B + w.x, B), 15).css(k.labelStyle).add(G), C = f(B + w.x, B) + c.zoomText.getBBox().width +
            ...
            t[b] = h.button(a.text, C, 0, function () {
              ...
              !1 !== e && c.clickButton(b);
              c.isActive = !0
            }, u, D && D.hover, D && D.select, D && D.disabled).attr({"text-align": "center"}).add(G);
          ...
          G.align({y: w.y, width: G.getBBox().width, align: w.align, x: U}, !0, e.spacingBox);
          c.group.placed = ca;
          ...
          if ("top" === X) n && (T = 0), e.titleOffset && (T = e.titleOffset + e.options.title.margin), T += e.margin[0] - e.spacing[0] || 0; else if ("middle" === X) if (Y === ba) T = 0 > Y ? b + void 0 : b; else if (Y || ba) T = 0 > Y || 0 > ba ? T - Math.min(Y, ba) : b - a + NaN;
    ...
    G.prototype.minFromRange = function () {
      var a = this.range, b = {month: "Month", year: "FullYear"}[a.type], c, e = this.max, g, h, l = function (a, c) {
    ...
    w(p.prototype, "render", function (a, b, c) {
      var e = this.axes, f = this.rangeSelector;
      f && (l(e, function (a) {
        a.updateNames();
        a.setScale()
  ...
  (function (a) {
    var B = a.addEvent, C = a.arrayMax, G = a.arrayMin, p = a.Axis, m = a.Chart, g = a.defined, v = a.each,
      z = a.extend, u = a.format, y = a.grep, l = a.inArray, b = a.isNumber, e = a.isString, t = a.map, n = a.merge,
      f = a.pick, c = a.Point, h = a.Renderer, w = a.Series, D = a.splat, r = a.SVGRenderer, J = a.VMLRenderer,
      q = a.wrap, F = w.prototype, x = F.init, K = F.processData, d = c.prototype.tooltipFormatter;
    a.StockChart = a.stockChart = function (b, c, d) {
      var g = e(b) || b.nodeName, k = arguments[g ? 1 : 0], h = k.series, l = a.getOptions(), p,
        q = f(k.navigator && k.navigator.enabled, l.navigator.enabled, !0),
        r = q ? {startOnTick: !1, endOnTick: !1} : null, u = {marker: {enabled: !1, radius: 2}}, v = {
          shadow: !1,
          borderWidth: 0
        };
      k.xAxis = t(D(k.xAxis || {}), function (a, b) {
        return n({
          ...
          showLastLabel: !0
        }, l.xAxis, l.xAxis && l.xAxis[b], a, {type: "datetime", categories: null}, r)
      });
      ...
      k = n({
        ...
        navigator: {enabled: q},
        scrollbar: {enabled: f(l.scrollbar.enabled, !0)},
        rangeSelector: {enabled: f(l.rangeSelector.enabled, !0)},
        title: {text: null},
        tooltip: {split: f(l.tooltip.split, !0), crosshairs: !0},
        legend: {enabled: !1},
        plotOptions: {
          line: u,
          spline: u,
    ...
    q(p.prototype, "getPlotLinePath", function (c, d, k, h, m, n) {
      var p = this, q = this.isLinked && !this.series ? this.linkedParent.series :
        this.series, r = p.chart, u = r.renderer, w = p.left, x = p.top, y, A, z, E, B = [], D = [], C, H;
      ...
      v(p.isXAxis ? r.yAxis : r.xAxis, function (a) {
        if (g(a.options.id) ? -1 === a.options.id.indexOf("navigator") : 1) {
          var b = a.isXAxis ? "yAxis" : "xAxis", b = g(a.options[b]) ? r[b][a.options[b]] : r[b][0];
          p === b && D.push(a)
        }
      });
      C = D.length ?
        [] : [p.isXAxis ? r.yAxis[0] : r.xAxis[0]];
      v(D, function (b) {
    ...
    B(p, "afterDrawCrosshair", function (a) {
      ...
      if (g(this.crosshair.label) &&
        ...
        var d = this.chart, e = this.options.crosshair.label, h = this.horiz;
        b = this.opposite;
        c = this.left;
        var l = this.top, m = this.crossLabel, n = e.format, p = "", q = "inside" === this.options.tickPosition,
          r = !1 !== this.crosshair.snap, t = 0, v = a.e || this.cross && this.cross.e, w = a.point;
        ...
        }).css(z({color: "#ffffff", fontWeight: "normal", fontSize: "11px", textAlign: "center"}, e.style)));
        ...
        m.attr({
          text: n ? u(n, {value: p}, d.time) : e.formatter.call(this, p),
          x: a,
          y: l,
    ...
    F.processData = function () {
      var a, c = -1, d, e, f = !0 === this.options.compareStart ? 0 : 1, g, h;
      K.apply(this, arguments);
      if (this.xAxis && this.processedYData) for (d = this.processedXData, e = this.processedYData, g = e.length, this.pointArrayMap && (c = l("close", this.pointArrayMap), -1 === c && (c = l(this.pointValKey || "y", this.pointArrayMap))), a = 0; a < g - f; a++) if (h = e[a] && -1 < c ? e[a][c] : e[a], b(h) && d[a + f] >= this.xAxis.min && 0 !== h) {
        this.compareValue = h;
        break
      }
    };
