...
(function (e) {
  ...
  (function (c) {
    var e = c.pick, h = c.each, p = c.error, k = c.Series, q = c.isArray, l = c.addEvent;
    c = c.seriesType;
    c("sma", "line", {name: void 0, tooltip: {valueDecimals: 4}, linkedTo: void 0, params: {index: 0, period: 14}}, {
