  ...
  window.onload = function () {
    ...
    function attachEvents() {
      ...
      var selectDropdowns,
        ...
        highchartsReset2 = document.getElementById('highcharts-reset2');
      ...
      highchartsReset2.addEventListener('click', function () {
              const chart = Highcharts.getChartById('container-inner');
              window.localStorage.removeItem('data');
              data = a;
              indicatorContainer.querySelectorAll('input')[0].checked = false;
              indicatorsList = []; // clear array too
